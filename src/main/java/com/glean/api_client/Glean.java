...
import com.glean.api_client.utils.RetryConfig;
import com.glean.api_client.utils.SpeakeasyHTTPClient;
...
public class Glean {
    ...
    public static class Builder {
        ...
        public Builder bearerAuth(String bearerAuth) {
            this.sdkConfiguration.securitySource = SecuritySource.of(com.glean.api_client.models.components.Security.builder()
        ...
        Builder _hooks(com.glean.api_client.utils.Hooks hooks) {
            sdkConfiguration.setHooks(hooks);  
            return this;  
        }
        
        // Visible for testing, may be accessed via reflection in tests
        Builder _hooks(Consumer<? super com.glean.api_client.utils.Hooks> consumer) {
