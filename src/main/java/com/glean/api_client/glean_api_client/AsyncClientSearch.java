...
public class AsyncClientSearch {
    private static final Headers _headers = Headers.EMPTY;
    private final SDKConfiguration sdkConfiguration;
    private final ClientSearch syncSDK;

    AsyncClientSearch(ClientSearch syncSDK, SDKConfiguration sdkConfiguration) {
