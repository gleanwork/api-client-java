...
public class AsyncTools {
     ...
     */
    public CompletableFuture<GetActionPackAuthStatusResponse> retrieveAuthStatus(String actionPackId) {
     ...
     */
    public CompletableFuture<AuthorizeActionPackResponse> authorize(String actionPackId, AuthorizeActionPackRequest authorizeActionPackRequest) {
