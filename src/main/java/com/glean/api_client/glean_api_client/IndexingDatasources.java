...
public class IndexingDatasources {
    ...
    IndexingDatasources(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.asyncSDK = new AsyncIndexingDatasources(this, sdkConfiguration);
    }
     ...
     */
    public AsyncIndexingDatasources async() {
        return asyncSDK;
    }
