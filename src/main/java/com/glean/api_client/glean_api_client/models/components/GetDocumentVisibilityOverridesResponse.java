...
public class GetDocumentVisibilityOverridesResponse {
    ...
    @JsonCreator
    public GetDocumentVisibilityOverridesResponse(
    ...
    public GetDocumentVisibilityOverridesResponse withVisibilityOverrides(List<DocumentVisibilityOverride> visibilityOverrides) {
        Utils.checkNotNull(visibilityOverrides, "visibilityOverrides");
    ...
    public GetDocumentVisibilityOverridesResponse withVisibilityOverrides(Optional<? extends List<DocumentVisibilityOverride>> visibilityOverrides) {
        Utils.checkNotNull(visibilityOverrides, "visibilityOverrides");
        this.visibilityOverrides = visibilityOverrides;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GetDocumentVisibilityOverridesResponse.class,
    ...
    public final static class Builder {
        ...
        public GetDocumentVisibilityOverridesResponse build() {

            return new GetDocumentVisibilityOverridesResponse(
                visibilityOverrides);
        }
