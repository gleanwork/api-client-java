...
public class GetAgentRequest {
     ...
     * <p>If not present or not supported, defaults to the closest match or `en`.
     */
    public GetAgentRequest withLocale(String locale) {
        Utils.checkNotNull(locale, "locale");
     ...
     * <p>If not present or not supported, defaults to the closest match or `en`.
     */
    public GetAgentRequest withLocale(Optional<String> locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
     ...
     * behind UTC.
     */
    public GetAgentRequest withTimezoneOffset(long timezoneOffset) {
        Utils.checkNotNull(timezoneOffset, "timezoneOffset");
     ...
     * behind UTC.
     */
    public GetAgentRequest withTimezoneOffset(Optional<Long> timezoneOffset) {
        Utils.checkNotNull(timezoneOffset, "timezoneOffset");
        this.timezoneOffset = timezoneOffset;
        return this;
    }
