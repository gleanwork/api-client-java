...
public class CreateannouncementResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public CreateannouncementResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CreateannouncementResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateannouncementResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public CreateannouncementResponse withAnnouncement(Announcement announcement) {
        Utils.checkNotNull(announcement, "announcement");
     ...
     * OK
     */
    public CreateannouncementResponse withAnnouncement(Optional<? extends Announcement> announcement) {
        Utils.checkNotNull(announcement, "announcement");
        this.announcement = announcement;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateannouncementResponse other = (CreateannouncementResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateannouncementResponse.class,
