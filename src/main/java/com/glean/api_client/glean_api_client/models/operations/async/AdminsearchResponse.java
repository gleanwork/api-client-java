...
public class AdminsearchResponse implements AsyncResponse {
    /**
    ...
    public AdminsearchResponse(
            ...
            Optional<? extends SearchResponse> searchResponse) {
     ...
     * HTTP response content type for this operation
     */
    public AdminsearchResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public AdminsearchResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AdminsearchResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public AdminsearchResponse withSearchResponse(SearchResponse searchResponse) {
        Utils.checkNotNull(searchResponse, "searchResponse");
     ...
     * OK
     */
    public AdminsearchResponse withSearchResponse(Optional<? extends SearchResponse> searchResponse) {
        Utils.checkNotNull(searchResponse, "searchResponse");
        this.searchResponse = searchResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AdminsearchResponse other = (AdminsearchResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AdminsearchResponse.class,
    ...
    public final static class Builder {
        ...
        public AdminsearchResponse build() {
