 ...
 * 
 * <p>Describes the request body of the /indexmembership API call
 */
public class IndexMembershipRequest {
     ...
     * The datasource for which the membership is added
     */
    public IndexMembershipRequest withDatasource(String datasource) {
        Utils.checkNotNull(datasource, "datasource");
        this.datasource = datasource;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IndexMembershipRequest other = (IndexMembershipRequest) o;
        return 
            Objects.deepEquals(this.version, other.version) &&
            Objects.deepEquals(this.datasource, other.datasource) &&
            Objects.deepEquals(this.membership, other.membership);
    }
    ...
    public String toString() {
        return Utils.toString(IndexMembershipRequest.class,
                "version", version,
    ...
    public final static class Builder {
        ...
        public IndexMembershipRequest build() {
            return new IndexMembershipRequest(
                version,
                datasource,
                membership);
        }
