...
public class Collection {
     ...
     * A list of added user roles for the Collection.
     */
    public Collection withAddedRoles(List<UserRoleSpecification> addedRoles) {
        Utils.checkNotNull(addedRoles, "addedRoles");
     ...
     * A list of added user roles for the Collection.
     */
    public Collection withAddedRoles(Optional<? extends List<UserRoleSpecification>> addedRoles) {
        Utils.checkNotNull(addedRoles, "addedRoles");
        this.addedRoles = addedRoles;
        return this;
    }
     ...
     * A list of removed user roles for the Collection.
     */
    public Collection withRemovedRoles(List<UserRoleSpecification> removedRoles) {
        Utils.checkNotNull(removedRoles, "removedRoles");
     ...
     * A list of removed user roles for the Collection.
     */
    public Collection withRemovedRoles(Optional<? extends List<UserRoleSpecification>> removedRoles) {
        Utils.checkNotNull(removedRoles, "removedRoles");
        this.removedRoles = removedRoles;
        return this;
    }
     ...
     * filters in people search.
     */
    public Collection withAudienceFilters(List<FacetFilter> audienceFilters) {
        Utils.checkNotNull(audienceFilters, "audienceFilters");
     ...
     * filters in people search.
     */
    public Collection withAudienceFilters(Optional<? extends List<FacetFilter>> audienceFilters) {
        Utils.checkNotNull(audienceFilters, "audienceFilters");
        this.audienceFilters = audienceFilters;
        return this;
    }
     ...
     * The emoji icon of this Collection.
     */
    public Collection withIcon(String icon) {
        Utils.checkNotNull(icon, "icon");
     ...
     * The emoji icon of this Collection.
     */
    public Collection withIcon(Optional<String> icon) {
        Utils.checkNotNull(icon, "icon");
        this.icon = icon;
        return this;
    }
     ...
     * Indicates whether edits are allowed for everyone or only admins.
     */
    public Collection withAdminLocked(boolean adminLocked) {
        Utils.checkNotNull(adminLocked, "adminLocked");
     ...
     * Indicates whether edits are allowed for everyone or only admins.
     */
    public Collection withAdminLocked(Optional<Boolean> adminLocked) {
        Utils.checkNotNull(adminLocked, "adminLocked");
        this.adminLocked = adminLocked;
        return this;
    }
     ...
     * The parent of this Collection, or 0 if it's a top-level Collection.
     */
    public Collection withParentId(long parentId) {
        Utils.checkNotNull(parentId, "parentId");
     ...
     * The parent of this Collection, or 0 if it's a top-level Collection.
     */
    public Collection withParentId(Optional<Long> parentId) {
        Utils.checkNotNull(parentId, "parentId");
        this.parentId = parentId;
        return this;
    }

    public Collection withThumbnail(Thumbnail thumbnail) {
        Utils.checkNotNull(thumbnail, "thumbnail");
     ...
     * The datasource type this Collection can hold.
     */
    public Collection withAllowedDatasource(String allowedDatasource) {
        Utils.checkNotNull(allowedDatasource, "allowedDatasource");
     ...
     * The datasource type this Collection can hold.
     */
    public Collection withAllowedDatasource(Optional<String> allowedDatasource) {
        Utils.checkNotNull(allowedDatasource, "allowedDatasource");
        this.allowedDatasource = allowedDatasource;
        return this;
    }

    public Collection withPermissions(ObjectPermissions permissions) {
        Utils.checkNotNull(permissions, "permissions");
    ...
    public Collection withCreateTime(OffsetDateTime createTime) {
        Utils.checkNotNull(createTime, "createTime");
    ...
    public Collection withUpdateTime(OffsetDateTime updateTime) {
        Utils.checkNotNull(updateTime, "updateTime");
    ...
    public Collection withCreator(Person creator) {
        Utils.checkNotNull(creator, "creator");
    ...
    public Collection withUpdatedBy(Person updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
     ...
     * count without items.
     */
    public Collection withItemCount(long itemCount) {
        Utils.checkNotNull(itemCount, "itemCount");
     ...
     * count without items.
     */
    public Collection withItemCount(Optional<Long> itemCount) {
        Utils.checkNotNull(itemCount, "itemCount");
        this.itemCount = itemCount;
        return this;
    }
     ...
     * without children.
     */
    public Collection withChildCount(long childCount) {
        Utils.checkNotNull(childCount, "childCount");
     ...
     * without children.
     */
    public Collection withChildCount(Optional<Long> childCount) {
        Utils.checkNotNull(childCount, "childCount");
        this.childCount = childCount;
        return this;
    }
     ...
     * The items in this Collection.
     */
    public Collection withItems(List<CollectionItem> items) {
        Utils.checkNotNull(items, "items");
     ...
     * The items in this Collection.
     */
    public Collection withItems(Optional<? extends List<CollectionItem>> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }

    public Collection withPinMetadata(CollectionPinnedMetadata pinMetadata) {
        Utils.checkNotNull(pinMetadata, "pinMetadata");
     ...
     * The names of the shortcuts (Go Links) that point to this Collection.
     */
    public Collection withShortcuts(List<String> shortcuts) {
        Utils.checkNotNull(shortcuts, "shortcuts");
     ...
     * The names of the shortcuts (Go Links) that point to this Collection.
     */
    public Collection withShortcuts(Optional<? extends List<String>> shortcuts) {
        Utils.checkNotNull(shortcuts, "shortcuts");
        this.shortcuts = shortcuts;
        return this;
    }
     ...
     * The children Collections of this Collection.
     */
    public Collection withChildren(List<Collection> children) {
        Utils.checkNotNull(children, "children");
     ...
     * The children Collections of this Collection.
     */
    public Collection withChildren(Optional<? extends List<Collection>> children) {
        Utils.checkNotNull(children, "children");
        this.children = children;
        return this;
    }
     ...
     * A list of user roles for the Collection.
     */
    public Collection withRoles(List<UserRoleSpecification> roles) {
        Utils.checkNotNull(roles, "roles");
     ...
     * A list of user roles for the Collection.
     */
    public Collection withRoles(Optional<? extends List<UserRoleSpecification>> roles) {
        Utils.checkNotNull(roles, "roles");
        this.roles = roles;
        return this;
    }
