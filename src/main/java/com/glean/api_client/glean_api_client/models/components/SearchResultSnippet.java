...
public class SearchResultSnippet {
    ...
    @Deprecated
    private Optional<String> snippet;
    ...
    public SearchResultSnippet(
            ...
            @JsonProperty("snippet") Optional<String> snippet) {
     ...
     */
    @Deprecated
    public SearchResultSnippet withSnippet(Optional<String> snippet) {
        Utils.checkNotNull(snippet, "snippet");
        this.snippet = snippet;
        return this;
    }
