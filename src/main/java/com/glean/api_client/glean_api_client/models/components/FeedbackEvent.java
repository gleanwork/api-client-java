...
public enum FeedbackEvent {
    ...
    public static Optional<FeedbackEvent> fromValue(String value) {
        for (FeedbackEvent o: FeedbackEvent.values()) {
