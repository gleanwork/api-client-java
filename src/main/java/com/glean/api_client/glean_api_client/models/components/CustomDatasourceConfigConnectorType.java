 ...
 */
public enum CustomDatasourceConfigConnectorType {
    API_CRAWL("API_CRAWL"),
    ...
    public static Optional<CustomDatasourceConfigConnectorType> fromValue(String value) {
        for (CustomDatasourceConfigConnectorType o: CustomDatasourceConfigConnectorType.values()) {
