...
public class Mode {
    ...
    public static final Mode DEFAULT = new Mode("DEFAULT");
    public static final Mode QUICK = new Mode("QUICK");
    ...
    private static final Map<String, ModeEnum> createEnumsMap() {
        ...
        map.put("DEFAULT", ModeEnum.DEFAULT);
        map.put("QUICK", ModeEnum.QUICK);
        return map;
    }
