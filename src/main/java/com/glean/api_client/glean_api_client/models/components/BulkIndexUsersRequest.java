...
public class BulkIndexUsersRequest {
    ...
    /**
     * True if older user data needs to be force deleted after the upload completes. Defaults to older data
     * being deleted only if the percentage of data being deleted is less than a reasonable threshold. This
     * must only be set when `isLastPage = true`
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public BulkIndexUsersRequest(
        ...
        this(uploadId, Optional.empty(), Optional.empty(),
            Optional.empty(), datasource, users,
            Optional.empty());
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            forceRestartUpload, datasource, users,
