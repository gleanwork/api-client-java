 ...
 * 
 * <p>Describes the request body of the /bulkindexteams API call
 */
public class BulkIndexTeamsRequest {
    /**
     ...
     */
    @JsonProperty("teams")
    private List<TeamInfoDefinition> teams;
    ...
    public BulkIndexTeamsRequest(
            ...
            @JsonProperty("teams") List<TeamInfoDefinition> teams) {
    ...
    public BulkIndexTeamsRequest(
            String uploadId,
            List<TeamInfoDefinition> teams) {
        this(uploadId, Optional.empty(), Optional.empty(),
            Optional.empty(), teams);
    }
     ...
     */
    @JsonIgnore
    public List<TeamInfoDefinition> teams() {
        return teams;
    }
     ...
     * Unique id that must be used for this bulk upload instance
     */
    public BulkIndexTeamsRequest withUploadId(String uploadId) {
        Utils.checkNotNull(uploadId, "uploadId");
        this.uploadId = uploadId;
        return this;
    }
     ...
     * true if this is the first page of the upload. Defaults to false
     */
    public BulkIndexTeamsRequest withIsFirstPage(boolean isFirstPage) {
        Utils.checkNotNull(isFirstPage, "isFirstPage");
     ...
     * true if this is the first page of the upload. Defaults to false
     */
    public BulkIndexTeamsRequest withIsFirstPage(Optional<Boolean> isFirstPage) {
        Utils.checkNotNull(isFirstPage, "isFirstPage");
        this.isFirstPage = isFirstPage;
        return this;
    }
     ...
     * true if this is the last page of the upload. Defaults to false
     */
    public BulkIndexTeamsRequest withIsLastPage(boolean isLastPage) {
        Utils.checkNotNull(isLastPage, "isLastPage");
     ...
     * true if this is the last page of the upload. Defaults to false
     */
    public BulkIndexTeamsRequest withIsLastPage(Optional<Boolean> isLastPage) {
        Utils.checkNotNull(isLastPage, "isLastPage");
        this.isLastPage = isLastPage;
        return this;
    }
     ...
     * isFirstPage=true
     */
    public BulkIndexTeamsRequest withForceRestartUpload(boolean forceRestartUpload) {
        Utils.checkNotNull(forceRestartUpload, "forceRestartUpload");
     ...
     * isFirstPage=true
     */
    public BulkIndexTeamsRequest withForceRestartUpload(Optional<Boolean> forceRestartUpload) {
        Utils.checkNotNull(forceRestartUpload, "forceRestartUpload");
        this.forceRestartUpload = forceRestartUpload;
        return this;
    }
     ...
     * Batch of team information
     */
    public BulkIndexTeamsRequest withTeams(List<TeamInfoDefinition> teams) {
        Utils.checkNotNull(teams, "teams");
        this.teams = teams;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BulkIndexTeamsRequest other = (BulkIndexTeamsRequest) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            forceRestartUpload, teams);
    }
    
    @Override
    public String toString() {
        return Utils.toString(BulkIndexTeamsRequest.class,
                "uploadId", uploadId,
    ...
    public final static class Builder {
         ...
         * Batch of team information
         */
        public Builder teams(List<TeamInfoDefinition> teams) {
            Utils.checkNotNull(teams, "teams");
            this.teams = teams;
            return this;
        }

        public BulkIndexTeamsRequest build() {

            return new BulkIndexTeamsRequest(
                uploadId, isFirstPage, isLastPage,
                forceRestartUpload, teams);
        }
