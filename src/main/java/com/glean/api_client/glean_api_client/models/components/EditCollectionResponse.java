...
public class EditCollectionResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("error")
    private Optional<? extends CollectionError2> error;
    ...
    @JsonIgnore
    public EditCollectionResponseErrorCode errorCode() {
        return errorCode;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<CollectionError2> error() {
     ...
     * The unique name of the Collection.
     */
    public EditCollectionResponse withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * A brief summary of the Collection's contents.
     */
    public EditCollectionResponse withDescription(String description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * A list of added user roles for the Collection.
     */
    public EditCollectionResponse withAddedRoles(List<UserRoleSpecification> addedRoles) {
        Utils.checkNotNull(addedRoles, "addedRoles");
     ...
     * A list of added user roles for the Collection.
     */
    public EditCollectionResponse withAddedRoles(Optional<? extends List<UserRoleSpecification>> addedRoles) {
        Utils.checkNotNull(addedRoles, "addedRoles");
        this.addedRoles = addedRoles;
        return this;
    }
     ...
     * A list of removed user roles for the Collection.
     */
    public EditCollectionResponse withRemovedRoles(List<UserRoleSpecification> removedRoles) {
        Utils.checkNotNull(removedRoles, "removedRoles");
     ...
     * A list of removed user roles for the Collection.
     */
    public EditCollectionResponse withRemovedRoles(Optional<? extends List<UserRoleSpecification>> removedRoles) {
        Utils.checkNotNull(removedRoles, "removedRoles");
        this.removedRoles = removedRoles;
        return this;
    }
     ...
     * The emoji icon of this Collection.
     */
    public EditCollectionResponse withIcon(String icon) {
        Utils.checkNotNull(icon, "icon");
     ...
     * The emoji icon of this Collection.
     */
    public EditCollectionResponse withIcon(Optional<String> icon) {
        Utils.checkNotNull(icon, "icon");
        this.icon = icon;
        return this;
    }
     ...
     * Indicates whether edits are allowed for everyone or only admins.
     */
    public EditCollectionResponse withAdminLocked(boolean adminLocked) {
        Utils.checkNotNull(adminLocked, "adminLocked");
     ...
     * Indicates whether edits are allowed for everyone or only admins.
     */
    public EditCollectionResponse withAdminLocked(Optional<Boolean> adminLocked) {
        Utils.checkNotNull(adminLocked, "adminLocked");
        this.adminLocked = adminLocked;
        return this;
    }
     ...
     * The parent of this Collection, or 0 if it's a top-level Collection.
     */
    public EditCollectionResponse withParentId(long parentId) {
        Utils.checkNotNull(parentId, "parentId");
     ...
     * The parent of this Collection, or 0 if it's a top-level Collection.
     */
    public EditCollectionResponse withParentId(Optional<Long> parentId) {
        Utils.checkNotNull(parentId, "parentId");
        this.parentId = parentId;
        return this;
    }

    public EditCollectionResponse withThumbnail(Thumbnail thumbnail) {
        Utils.checkNotNull(thumbnail, "thumbnail");
     ...
     * The datasource type this Collection can hold.
     */
    public EditCollectionResponse withAllowedDatasource(String allowedDatasource) {
        Utils.checkNotNull(allowedDatasource, "allowedDatasource");
     ...
     * The datasource type this Collection can hold.
     */
    public EditCollectionResponse withAllowedDatasource(Optional<String> allowedDatasource) {
        Utils.checkNotNull(allowedDatasource, "allowedDatasource");
        this.allowedDatasource = allowedDatasource;
        return this;
    }

    public EditCollectionResponse withPermissions(ObjectPermissions permissions) {
        Utils.checkNotNull(permissions, "permissions");
    ...
    public EditCollectionResponse withCreateTime(OffsetDateTime createTime) {
        Utils.checkNotNull(createTime, "createTime");
    ...
    public EditCollectionResponse withUpdateTime(OffsetDateTime updateTime) {
        Utils.checkNotNull(updateTime, "updateTime");
    ...
    public EditCollectionResponse withCreator(Person creator) {
        Utils.checkNotNull(creator, "creator");
    ...
    public EditCollectionResponse withUpdatedBy(Person updatedBy) {
        Utils.checkNotNull(updatedBy, "updatedBy");
     ...
     * The items in this Collection.
     */
    public EditCollectionResponse withItems(List<CollectionItem> items) {
        Utils.checkNotNull(items, "items");
     ...
     * The items in this Collection.
     */
    public EditCollectionResponse withItems(Optional<? extends List<CollectionItem>> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }

    public EditCollectionResponse withPinMetadata(CollectionPinnedMetadata pinMetadata) {
        Utils.checkNotNull(pinMetadata, "pinMetadata");
     ...
     * The names of the shortcuts (Go Links) that point to this Collection.
     */
    public EditCollectionResponse withShortcuts(List<String> shortcuts) {
        Utils.checkNotNull(shortcuts, "shortcuts");
     ...
     * The names of the shortcuts (Go Links) that point to this Collection.
     */
    public EditCollectionResponse withShortcuts(Optional<? extends List<String>> shortcuts) {
        Utils.checkNotNull(shortcuts, "shortcuts");
        this.shortcuts = shortcuts;
        return this;
    }
     ...
     * The children Collections of this Collection.
     */
    public EditCollectionResponse withChildren(List<Collection> children) {
        Utils.checkNotNull(children, "children");
     ...
     * The children Collections of this Collection.
     */
    public EditCollectionResponse withChildren(Optional<? extends List<Collection>> children) {
        Utils.checkNotNull(children, "children");
        this.children = children;
        return this;
    }
     ...
     * A list of user roles for the Collection.
     */
    public EditCollectionResponse withRoles(List<UserRoleSpecification> roles) {
        Utils.checkNotNull(roles, "roles");
     ...
     * A list of user roles for the Collection.
     */
    public EditCollectionResponse withRoles(Optional<? extends List<UserRoleSpecification>> roles) {
        Utils.checkNotNull(roles, "roles");
        this.roles = roles;
        return this;
    }
    ...
    public EditCollectionResponse withCollection(Collection collection) {
        Utils.checkNotNull(collection, "collection");
    ...
    public EditCollectionResponse withError(CollectionError2 error) {
        Utils.checkNotNull(error, "error");
    ...
    public final static class Builder {
        ...
        public Builder error(Optional<? extends CollectionError2> error) {
            Utils.checkNotNull(error, "error");
            this.error = error;
            return this;
        }
