...
public class GetDlpReportResponse {
    /**
     ...
     * Full policy information that will be used for scans.
     */
    public GetDlpReportResponse withReport(DlpReport report) {
        Utils.checkNotNull(report, "report");
     ...
     * Full policy information that will be used for scans.
     */
    public GetDlpReportResponse withReport(Optional<? extends DlpReport> report) {
        Utils.checkNotNull(report, "report");
        this.report = report;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDlpReportResponse other = (GetDlpReportResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetDlpReportResponse.class,
                "report", report);
    }
    ...
    public final static class Builder {
        ...
        public GetDlpReportResponse build() {

            return new GetDlpReportResponse(
                report);
        }
