...
public class PlatformAgentsCreateRun {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformAgentsCreateRunRequest, PlatformAgentsCreateRunResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformAgentsCreateRunRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsCreateRunRequest.class, new TypeReference<PlatformAgentsCreateRunRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformAgentsCreateRunRequest request) {
        ...
        @Override
        public PlatformAgentsCreateRunResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformAgentsCreateRunResponse.Builder resBuilder =
            ...
            PlatformAgentsCreateRunResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformAgentRunWaitResponse(Utils.unmarshal(response, new TypeReference<PlatformAgentRunWaitResponse>() {}));
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "403", "404", "408", "409", "429")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformAgentsCreateRunRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformAgentsCreateRunRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsCreateRunRequest.class, new TypeReference<PlatformAgentsCreateRunRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformAgentsCreateRunRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformAgentRunWaitResponse>() {})
                            .thenApply(res::withPlatformAgentRunWaitResponse);
                } else if (Utils.contentTypeMatches(contentType, "text/event-stream")) {
