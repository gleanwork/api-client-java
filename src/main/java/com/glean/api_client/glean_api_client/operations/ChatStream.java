...
public class ChatStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<ChatStreamRequest, ChatStreamResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ChatStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ChatStreamRequest.class, new TypeReference<ChatStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ChatStreamRequest request) throws Exception {
        ...
        @Override
        public ChatStreamResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ChatStreamResponse.Builder resBuilder =
                    ChatStreamResponse
                            .builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ChatStreamRequest, com.glean.api_client.glean_api_client.models.operations.async.ChatStreamResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ChatStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ChatStreamRequest.class, new TypeReference<ChatStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ChatStreamRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ChatStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ChatStreamResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ChatStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ChatStreamResponse res = resBuilder.build();
