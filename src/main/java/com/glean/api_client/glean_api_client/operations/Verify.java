...
public class Verify {
    ...
    public static class Sync extends Base
            implements RequestOperation<VerifyRequest, VerifyResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerifyRequest request) {
        ...
        @Override
        public VerifyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VerifyResponse.Builder resBuilder =
                    VerifyResponse
                            .builder()
            ...
            VerifyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVerification(Utils.unmarshal(response, new TypeReference<Verification>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VerifyRequest, com.glean.api_client.glean_api_client.models.operations.async.VerifyResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VerifyRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.VerifyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.VerifyResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.VerifyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.VerifyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Verification>() {})
                            .thenApply(res::withVerification);
                } else {
