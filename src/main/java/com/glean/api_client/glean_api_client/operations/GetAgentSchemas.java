...
public class GetAgentSchemas {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAgentSchemasRequest, GetAgentSchemasResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAgentSchemasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAgentSchemasRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAgentSchemasRequest request) {
        ...
        @Override
        public GetAgentSchemasResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAgentSchemas(Utils.unmarshal(response, new TypeReference<AgentSchemas>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAgentSchemasRequest, com.glean.api_client.glean_api_client.models.operations.async.GetAgentSchemasResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAgentSchemasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAgentSchemasRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAgentSchemasRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetAgentSchemasResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetAgentSchemasResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetAgentSchemasResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetAgentSchemasResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AgentSchemas>() {})
                            .thenApply(res::withAgentSchemas);
                } else {
