...
public class PlatformTriggersEventsSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformTriggersEventsSearchRequest, PlatformTriggersEventsSearchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformTriggersEventsSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggersEventsSearchRequest.class, new TypeReference<PlatformTriggersEventsSearchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformTriggersEventsSearchRequest request) {
        ...
        @Override
        public PlatformTriggersEventsSearchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformTriggersEventsSearchResponse.Builder resBuilder =
                    PlatformTriggersEventsSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PlatformTriggersEventsSearchResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformTriggersEventsSearchRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersEventsSearchResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformTriggersEventsSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggersEventsSearchRequest.class, new TypeReference<PlatformTriggersEventsSearchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformTriggersEventsSearchRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersEventsSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersEventsSearchResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersEventsSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersEventsSearchResponse res = resBuilder.build();
