...
public class PlatformSkillsGetContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSkillsGetContentRequest, PlatformSkillsGetContentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSkillsGetContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsGetContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSkillsGetContentRequest request) {
        ...
        @Override
        public PlatformSkillsGetContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSkillsGetContentResponse.Builder resBuilder =
            ...
            PlatformSkillsGetContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSkillsGetContentRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetContentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSkillsGetContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsGetContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSkillsGetContentRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetContentResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetContentResponse res = resBuilder.build();
