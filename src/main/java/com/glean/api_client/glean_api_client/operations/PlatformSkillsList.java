...
public class PlatformSkillsList {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSkillsListRequest, PlatformSkillsListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSkillsListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSkillsListRequest request) {
        ...
        @Override
        public PlatformSkillsListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSkillsListResponse.Builder resBuilder =
            ...
            PlatformSkillsListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformSkillsListResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PlatformSkillsListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSkillsListRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsListResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSkillsListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSkillsListRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsListResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PlatformSkillsListResponse>() {})
                            .thenApply(res::withPlatformSkillsListResponse);
                } else {
