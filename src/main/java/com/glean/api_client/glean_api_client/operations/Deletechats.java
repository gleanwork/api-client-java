...
public class Deletechats {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletechatsRequest, DeletechatsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletechatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletechatsRequest.class, new TypeReference<DeletechatsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletechatsRequest request) throws Exception {
        ...
        @Override
        public DeletechatsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletechatsResponse.Builder resBuilder =
                    DeletechatsResponse
                            .builder()
            ...
            DeletechatsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletechatsRequest, com.glean.api_client.glean_api_client.models.operations.async.DeletechatsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletechatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletechatsRequest.class, new TypeReference<DeletechatsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletechatsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.DeletechatsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.DeletechatsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.DeletechatsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.DeletechatsResponse res = resBuilder.build();
