...
public class PlatformSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSearchRequest, PlatformSearchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PlatformSearchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSearchRequest request) {
        ...
        @Override
        public PlatformSearchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSearchResponse.Builder resBuilder =
            ...
            PlatformSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformSearchResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PlatformSearchResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSearchRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PlatformSearchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSearchRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PlatformSearchResponse>() {})
                            .thenApply(res::withPlatformSearchResponse);
                } else {
