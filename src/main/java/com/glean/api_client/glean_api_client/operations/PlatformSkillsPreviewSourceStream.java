...
public class PlatformSkillsPreviewSourceStream {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "platform-skills-preview-source-stream",
        ...
        <T, U>HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    this.baseUrl,
                    "/api/skills/sources/preview#stream");
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSkillsPreviewSourceStreamRequest, PlatformSkillsPreviewSourceStreamResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSkillsPreviewSourceStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PlatformSkillsPreviewSourceStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSkillsPreviewSourceStreamRequest request) {
        ...
        @Override
        public PlatformSkillsPreviewSourceStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSkillsPreviewSourceStreamResponse.Builder resBuilder =
                    PlatformSkillsPreviewSourceStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PlatformSkillsPreviewSourceStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSkillsPreviewSourceStreamRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsPreviewSourceStreamResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSkillsPreviewSourceStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PlatformSkillsPreviewSourceStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSkillsPreviewSourceStreamRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsPreviewSourceStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsPreviewSourceStreamResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsPreviewSourceStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsPreviewSourceStreamResponse res = resBuilder.build();
