...
public class GetActionAuthStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetActionAuthStatusRequest, GetActionAuthStatusResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetActionAuthStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActionAuthStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetActionAuthStatusRequest request) {
        ...
        @Override
        public GetActionAuthStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetActionAuthStatusResponse.Builder resBuilder =
                    GetActionAuthStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetActionAuthStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withActionAuthStatusResponse(Utils.unmarshal(response, new TypeReference<ActionAuthStatusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetActionAuthStatusRequest, com.glean.api_client.glean_api_client.models.operations.async.GetActionAuthStatusResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetActionAuthStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActionAuthStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetActionAuthStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetActionAuthStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetActionAuthStatusResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetActionAuthStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetActionAuthStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ActionAuthStatusResponse>() {})
                            .thenApply(res::withActionAuthStatusResponse);
                } else {
