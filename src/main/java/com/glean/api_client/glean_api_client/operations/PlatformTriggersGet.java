...
public class PlatformTriggersGet {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformTriggersGetRequest, PlatformTriggersGetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformTriggersGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggersGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformTriggersGetRequest request) {
        ...
        @Override
        public PlatformTriggersGetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformTriggersGetResponse.Builder resBuilder =
            ...
            PlatformTriggersGetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformTriggersGetRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformTriggersGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggersGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformTriggersGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersGetResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersGetResponse res = resBuilder.build();
