...
public class Downloadreportcsv {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(DownloadreportcsvRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DownloadreportcsvRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DownloadreportcsvRequest, com.glean.api_client.glean_api_client.models.operations.async.DownloadreportcsvResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DownloadreportcsvRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DownloadreportcsvRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DownloadreportcsvRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.DownloadreportcsvResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.DownloadreportcsvResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.DownloadreportcsvResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.DownloadreportcsvResponse res = resBuilder.build();
