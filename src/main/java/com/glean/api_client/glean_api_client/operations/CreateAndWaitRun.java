...
public class CreateAndWaitRun {
    ...
    public static class Sync extends Base
        ...
        @Override
        public CreateAndWaitRunResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AgentRunWaitResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAgentRunWaitResponse(out);
                    return res;
                } else {
