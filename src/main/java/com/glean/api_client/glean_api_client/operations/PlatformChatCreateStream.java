...
public class PlatformChatCreateStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformChatCreateStreamRequest, PlatformChatCreateStreamResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformChatCreateStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PlatformChatCreateStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformChatCreateStreamRequest request) {
        ...
        @Override
        public PlatformChatCreateStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformChatCreateStreamResponse.Builder resBuilder =
            ...
            PlatformChatCreateStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformChatCreateStreamRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformChatCreateStreamResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformChatCreateStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PlatformChatCreateStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformChatCreateStreamRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformChatCreateStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformChatCreateStreamResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformChatCreateStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformChatCreateStreamResponse res = resBuilder.build();
