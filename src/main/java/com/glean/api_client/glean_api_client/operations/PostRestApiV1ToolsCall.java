...
public class PostRestApiV1ToolsCall {
    ...
    public static class Sync extends Base
            implements RequestOperation<ToolsCallRequest, PostRestApiV1ToolsCallResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ToolsCallRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ToolsCallRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ToolsCallRequest request) {
        ...
        @Override
        public PostRestApiV1ToolsCallResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withToolsCallResponse(Utils.unmarshal(response, new TypeReference<ToolsCallResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ToolsCallRequest, com.glean.api_client.glean_api_client.models.operations.async.PostRestApiV1ToolsCallResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ToolsCallRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ToolsCallRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ToolsCallRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostRestApiV1ToolsCallResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostRestApiV1ToolsCallResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostRestApiV1ToolsCallResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostRestApiV1ToolsCallResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ToolsCallResponse>() {})
                            .thenApply(res::withToolsCallResponse);
                } else {
