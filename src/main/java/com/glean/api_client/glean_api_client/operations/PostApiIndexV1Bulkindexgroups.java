...
public class PostApiIndexV1Bulkindexgroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<BulkIndexGroupsRequest, PostApiIndexV1BulkindexgroupsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(BulkIndexGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BulkIndexGroupsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BulkIndexGroupsRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1BulkindexgroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1BulkindexgroupsResponse.Builder resBuilder =
            ...
            PostApiIndexV1BulkindexgroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<BulkIndexGroupsRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexgroupsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(BulkIndexGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BulkIndexGroupsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BulkIndexGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexgroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexgroupsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexgroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexgroupsResponse res = resBuilder.build();
