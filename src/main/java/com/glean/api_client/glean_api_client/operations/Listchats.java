...
public class Listchats {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListchatsRequest, ListchatsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListchatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListchatsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListchatsRequest request) {
        ...
        @Override
        public ListchatsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListchatsResponse.Builder resBuilder =
                    ListchatsResponse
                            .builder()
            ...
            ListchatsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListChatsResponse(Utils.unmarshal(response, new TypeReference<ListChatsResponse>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "429", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListchatsRequest, com.glean.api_client.glean_api_client.models.operations.async.ListchatsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListchatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListchatsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListchatsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ListchatsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ListchatsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ListchatsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ListchatsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListChatsResponse>() {})
                            .thenApply(res::withListChatsResponse);
                } else {
