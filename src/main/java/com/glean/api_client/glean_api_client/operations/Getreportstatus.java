...
public class Getreportstatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetreportstatusRequest, GetreportstatusResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetreportstatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetreportstatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetreportstatusRequest request) {
        ...
        @Override
        public GetreportstatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetreportstatusResponse.Builder resBuilder =
            ...
            GetreportstatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return res.withReportStatusResponse(Utils.unmarshal(response, new TypeReference<ReportStatusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetreportstatusRequest, com.glean.api_client.glean_api_client.models.operations.async.GetreportstatusResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetreportstatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetreportstatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetreportstatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetreportstatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetreportstatusResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetreportstatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetreportstatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ReportStatusResponse>() {})
                            .thenApply(res::withReportStatusResponse);
                } else {
