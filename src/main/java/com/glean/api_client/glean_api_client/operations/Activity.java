...
public class Activity {
    ...
    public static class Sync extends Base
            implements RequestOperation<com.glean.api_client.glean_api_client.models.components.Activity, ActivityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(com.glean.api_client.glean_api_client.models.components.Activity request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<com.glean.api_client.glean_api_client.models.components.Activity>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(com.glean.api_client.glean_api_client.models.components.Activity request) throws Exception {
        ...
        @Override
        public ActivityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ActivityResponse.Builder resBuilder =
                    ActivityResponse
                            .builder()
            ...
            ActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<com.glean.api_client.glean_api_client.models.components.Activity, com.glean.api_client.glean_api_client.models.operations.async.ActivityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(com.glean.api_client.glean_api_client.models.components.Activity request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<com.glean.api_client.glean_api_client.models.components.Activity>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(com.glean.api_client.glean_api_client.models.components.Activity request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ActivityResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ActivityResponse res = resBuilder.build();
