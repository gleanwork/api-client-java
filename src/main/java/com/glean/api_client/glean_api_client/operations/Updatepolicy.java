...
public class Updatepolicy {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatepolicyRequest, UpdatepolicyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatepolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatepolicyRequest.class, new TypeReference<UpdatepolicyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatepolicyRequest request) {
        ...
        @Override
        public UpdatepolicyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatepolicyResponse.Builder resBuilder =
            ...
            UpdatepolicyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return res.withUpdateDlpReportResponse(Utils.unmarshal(response, new TypeReference<UpdateDlpReportResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatepolicyRequest, com.glean.api_client.glean_api_client.models.operations.async.UpdatepolicyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatepolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatepolicyRequest.class, new TypeReference<UpdatepolicyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatepolicyRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.UpdatepolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.UpdatepolicyResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.UpdatepolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.UpdatepolicyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateDlpReportResponse>() {})
                            .thenApply(res::withUpdateDlpReportResponse);
                } else {
