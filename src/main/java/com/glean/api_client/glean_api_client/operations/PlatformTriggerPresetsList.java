...
public class PlatformTriggerPresetsList {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformTriggerPresetsListRequest, PlatformTriggerPresetsListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformTriggerPresetsListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggerPresetsListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformTriggerPresetsListRequest request) {
        ...
        @Override
        public PlatformTriggerPresetsListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformTriggerPresetsListResponse.Builder resBuilder =
            ...
            PlatformTriggerPresetsListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformTriggerPresetListResponse(Utils.unmarshal(response, new TypeReference<PlatformTriggerPresetListResponse>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "403", "408", "429")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformTriggerPresetsListRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsListResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformTriggerPresetsListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggerPresetsListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformTriggerPresetsListRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsListResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformTriggerPresetListResponse>() {})
                            .thenApply(res::withPlatformTriggerPresetListResponse);
                } else {
