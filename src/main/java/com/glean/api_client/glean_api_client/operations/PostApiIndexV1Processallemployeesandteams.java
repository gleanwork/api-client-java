...
public class PostApiIndexV1Processallemployeesandteams {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<PostApiIndexV1ProcessallemployeesandteamsResponse> {
        ...
        public PostApiIndexV1ProcessallemployeesandteamsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            PostApiIndexV1ProcessallemployeesandteamsResponse.Builder resBuilder =
            ...
            PostApiIndexV1ProcessallemployeesandteamsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallemployeesandteamsResponse> {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallemployeesandteamsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallemployeesandteamsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallemployeesandteamsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallemployeesandteamsResponse res = resBuilder.build();
