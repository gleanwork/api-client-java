...
public class PostApiIndexV1Deleteemployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteEmployeeRequest, PostApiIndexV1DeleteemployeeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DeleteEmployeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteEmployeeRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1DeleteemployeeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1DeleteemployeeResponse.Builder resBuilder =
            ...
            PostApiIndexV1DeleteemployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteEmployeeRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeleteemployeeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DeleteEmployeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeleteemployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeleteemployeeResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeleteemployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeleteemployeeResponse res = resBuilder.build();
