...
public class GetDatasourceInstanceConfiguration {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatasourceInstanceConfigurationRequest, GetDatasourceInstanceConfigurationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatasourceInstanceConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatasourceInstanceConfigurationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatasourceInstanceConfigurationRequest request) {
        ...
        @Override
        public GetDatasourceInstanceConfigurationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatasourceInstanceConfigurationResponse.Builder resBuilder =
            ...
            GetDatasourceInstanceConfigurationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatasourceInstanceConfigurationRequest, com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceInstanceConfigurationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatasourceInstanceConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatasourceInstanceConfigurationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatasourceInstanceConfigurationRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceInstanceConfigurationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceInstanceConfigurationResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceInstanceConfigurationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceInstanceConfigurationResponse res = resBuilder.build();
