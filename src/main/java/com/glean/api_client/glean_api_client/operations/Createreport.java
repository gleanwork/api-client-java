...
public class Createreport {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateDlpConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdateDlpConfigRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDlpConfigRequest request) {
        ...
        @Override
        public CreatereportResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return res.withUpdateDlpConfigResponse(Utils.unmarshal(response, new TypeReference<UpdateDlpConfigResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDlpConfigRequest, com.glean.api_client.glean_api_client.models.operations.async.CreatereportResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDlpConfigRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdateDlpConfigRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDlpConfigRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.CreatereportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.CreatereportResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.CreatereportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.CreatereportResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateDlpConfigResponse>() {})
                            .thenApply(res::withUpdateDlpConfigResponse);
                } else {
