...
public class PlatformTriggersUpdate {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformTriggersUpdateRequest, PlatformTriggersUpdateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformTriggersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggersUpdateRequest.class, new TypeReference<PlatformTriggersUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformTriggersUpdateRequest request) {
        ...
        @Override
        public PlatformTriggersUpdateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformTriggersUpdateResponse.Builder resBuilder =
                    PlatformTriggersUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PlatformTriggersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformTriggerGetResponse(Utils.unmarshal(response, new TypeReference<PlatformTriggerGetResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformTriggersUpdateRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersUpdateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformTriggersUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggersUpdateRequest.class, new TypeReference<PlatformTriggersUpdateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformTriggersUpdateRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersUpdateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersUpdateResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersUpdateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggersUpdateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformTriggerGetResponse>() {})
                            .thenApply(res::withPlatformTriggerGetResponse);
                } else {
