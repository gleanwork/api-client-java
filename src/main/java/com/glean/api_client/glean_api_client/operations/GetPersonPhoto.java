...
public class GetPersonPhoto {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "image/jpeg;q=1, image/png;q=0")
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPersonPhotoRequest, GetPersonPhotoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPersonPhotoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPersonPhotoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPersonPhotoRequest request) {
        ...
        @Override
        public GetPersonPhotoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPersonPhotoResponse.Builder resBuilder =
            ...
            GetPersonPhotoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPersonPhotoRequest, com.glean.api_client.glean_api_client.models.operations.async.GetPersonPhotoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPersonPhotoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPersonPhotoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPersonPhotoRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetPersonPhotoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetPersonPhotoResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetPersonPhotoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            com.glean.api_client.glean_api_client.models.operations.async.GetPersonPhotoResponse res = resBuilder.build();
