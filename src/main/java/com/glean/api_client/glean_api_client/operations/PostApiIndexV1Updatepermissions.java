...
public class PostApiIndexV1Updatepermissions {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePermissionsRequest, PostApiIndexV1UpdatepermissionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePermissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdatePermissionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePermissionsRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "409", "429", "4XX", "5XX")) {
        ...
        @Override
        public PostApiIndexV1UpdatepermissionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1UpdatepermissionsResponse.Builder resBuilder =
            ...
            PostApiIndexV1UpdatepermissionsResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "409", "429", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePermissionsRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1UpdatepermissionsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePermissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdatePermissionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePermissionsRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "409", "429", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1UpdatepermissionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1UpdatepermissionsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1UpdatepermissionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1UpdatepermissionsResponse res = resBuilder.build();
