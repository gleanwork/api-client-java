...
public class CreateanswerOperation implements RequestOperation<CreateAnswerRequest, CreateanswerResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateanswerOperation(SDKConfiguration sdkConfiguration) {
