...
public class Listentities {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListentitiesRequest, ListentitiesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListentitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListentitiesRequest.class, new TypeReference<ListentitiesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListentitiesRequest request) {
        ...
        @Override
        public ListentitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListentitiesResponse.Builder resBuilder =
            ...
            ListentitiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListEntitiesResponse(Utils.unmarshal(response, new TypeReference<ListEntitiesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListentitiesRequest, com.glean.api_client.glean_api_client.models.operations.async.ListentitiesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListentitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListentitiesRequest.class, new TypeReference<ListentitiesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListentitiesRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ListentitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ListentitiesResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ListentitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ListentitiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListEntitiesResponse>() {})
                            .thenApply(res::withListEntitiesResponse);
                } else {
