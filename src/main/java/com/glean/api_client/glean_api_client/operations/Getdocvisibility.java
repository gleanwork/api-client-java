...
public class Getdocvisibility {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetdocvisibilityRequest, GetdocvisibilityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetdocvisibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetdocvisibilityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetdocvisibilityRequest request) {
        ...
        @Override
        public GetdocvisibilityResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return res.withGetDocumentVisibilityOverridesResponse(Utils.unmarshal(response, new TypeReference<GetDocumentVisibilityOverridesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetdocvisibilityRequest, com.glean.api_client.glean_api_client.models.operations.async.GetdocvisibilityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetdocvisibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetdocvisibilityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetdocvisibilityRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetdocvisibilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetdocvisibilityResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetdocvisibilityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetdocvisibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDocumentVisibilityOverridesResponse>() {})
                            .thenApply(res::withGetDocumentVisibilityOverridesResponse);
                } else {
