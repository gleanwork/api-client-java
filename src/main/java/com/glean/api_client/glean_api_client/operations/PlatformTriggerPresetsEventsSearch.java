...
public class PlatformTriggerPresetsEventsSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformTriggerPresetsEventsSearchRequest, PlatformTriggerPresetsEventsSearchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformTriggerPresetsEventsSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggerPresetsEventsSearchRequest.class, new TypeReference<PlatformTriggerPresetsEventsSearchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformTriggerPresetsEventsSearchRequest request) {
        ...
        @Override
        public PlatformTriggerPresetsEventsSearchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformTriggerPresetsEventsSearchResponse.Builder resBuilder =
            ...
            PlatformTriggerPresetsEventsSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformTriggerEventSearchResponse(Utils.unmarshal(response, new TypeReference<PlatformTriggerEventSearchResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformTriggerPresetsEventsSearchRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsEventsSearchResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformTriggerPresetsEventsSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggerPresetsEventsSearchRequest.class, new TypeReference<PlatformTriggerPresetsEventsSearchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformTriggerPresetsEventsSearchRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsEventsSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsEventsSearchResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsEventsSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsEventsSearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformTriggerEventSearchResponse>() {})
                            .thenApply(res::withPlatformTriggerEventSearchResponse);
                } else {
