...
public class PlatformSkillsGetVersionContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSkillsGetVersionContentRequest, PlatformSkillsGetVersionContentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSkillsGetVersionContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsGetVersionContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSkillsGetVersionContentRequest request) {
        ...
        @Override
        public PlatformSkillsGetVersionContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSkillsGetVersionContentResponse.Builder resBuilder =
            ...
            PlatformSkillsGetVersionContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSkillsGetVersionContentRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetVersionContentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSkillsGetVersionContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsGetVersionContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSkillsGetVersionContentRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetVersionContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetVersionContentResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetVersionContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetVersionContentResponse res = resBuilder.build();
