...
public class Createannouncement {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateannouncementRequest, CreateannouncementResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateannouncementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateannouncementRequest.class, new TypeReference<CreateannouncementRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateannouncementRequest request) {
        ...
        @Override
        public CreateannouncementResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateannouncementResponse.Builder resBuilder =
            ...
            CreateannouncementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnnouncement(Utils.unmarshal(response, new TypeReference<Announcement>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateannouncementRequest, com.glean.api_client.glean_api_client.models.operations.async.CreateannouncementResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateannouncementRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateannouncementRequest.class, new TypeReference<CreateannouncementRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateannouncementRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.CreateannouncementResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.CreateannouncementResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.CreateannouncementResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.CreateannouncementResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Announcement>() {})
                            .thenApply(res::withAnnouncement);
                } else {
