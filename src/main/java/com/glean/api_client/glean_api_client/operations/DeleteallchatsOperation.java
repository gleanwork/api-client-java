...
public class DeleteallchatsOperation implements RequestOperation<DeleteallchatsRequest, DeleteallchatsResponse> {
    ...
    @Override
    public DeleteallchatsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DeleteallchatsResponse.Builder resBuilder = 
        ...
        DeleteallchatsResponse res = resBuilder.build();
