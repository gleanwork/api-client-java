...
public class Uploadchatfiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadchatfilesRequest, UploadchatfilesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UploadchatfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadchatfilesRequest.class, new TypeReference<UploadchatfilesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadchatfilesRequest request) {
        ...
        @Override
        public UploadchatfilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadchatfilesResponse.Builder resBuilder =
            ...
            UploadchatfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUploadChatFilesResponse(Utils.unmarshal(response, new TypeReference<UploadChatFilesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UploadchatfilesRequest, com.glean.api_client.glean_api_client.models.operations.async.UploadchatfilesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UploadchatfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadchatfilesRequest.class, new TypeReference<UploadchatfilesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UploadchatfilesRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.UploadchatfilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.UploadchatfilesResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.UploadchatfilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.UploadchatfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UploadChatFilesResponse>() {})
                            .thenApply(res::withUploadChatFilesResponse);
                } else {
