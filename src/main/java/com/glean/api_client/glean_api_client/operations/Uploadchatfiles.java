...
public class Uploadchatfiles {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadchatfilesRequest request) throws Exception {
        ...
        @Override
        public UploadchatfilesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UploadChatFilesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUploadChatFilesResponse(out);
                    return res;
                } else {
