...
public class Checkdatasourceauth {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<CheckdatasourceauthResponse> {
        ...
        @Override
        public CheckdatasourceauthResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CheckdatasourceauthResponse.Builder resBuilder =
            ...
            CheckdatasourceauthResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCheckDatasourceAuthResponse(Utils.unmarshal(response, new TypeReference<CheckDatasourceAuthResponse>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401", "429", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.glean.api_client.glean_api_client.models.operations.async.CheckdatasourceauthResponse> {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.CheckdatasourceauthResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.CheckdatasourceauthResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.CheckdatasourceauthResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.CheckdatasourceauthResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CheckDatasourceAuthResponse>() {})
                            .thenApply(res::withCheckDatasourceAuthResponse);
                } else {
