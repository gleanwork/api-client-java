...
public class UnpinOperation implements RequestOperation<Unpin, UnpinResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UnpinOperation(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }
    
    @Override
    public HttpResponse<InputStream> doRequest(Unpin request) throws Exception {
