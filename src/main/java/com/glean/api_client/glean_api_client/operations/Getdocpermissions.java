...
public class Getdocpermissions {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetdocpermissionsRequest, GetdocpermissionsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetdocpermissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetdocpermissionsRequest.class, new TypeReference<GetdocpermissionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetdocpermissionsRequest request) {
        ...
        @Override
        public GetdocpermissionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetDocPermissionsResponse(Utils.unmarshal(response, new TypeReference<GetDocPermissionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetdocpermissionsRequest, com.glean.api_client.glean_api_client.models.operations.async.GetdocpermissionsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetdocpermissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetdocpermissionsRequest.class, new TypeReference<GetdocpermissionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetdocpermissionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetdocpermissionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetdocpermissionsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetdocpermissionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetdocpermissionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDocPermissionsResponse>() {})
                            .thenApply(res::withGetDocPermissionsResponse);
                } else {
