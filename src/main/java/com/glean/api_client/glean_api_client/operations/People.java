...
import com.glean.api_client.glean_api_client.models.operations.PeopleRequest;
...
public class People {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(PeopleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PeopleRequest.class, new TypeReference<PeopleRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PeopleRequest request) {
        ...
        @Override
        public PeopleResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPeopleResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PeopleResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PeopleRequest, com.glean.api_client.glean_api_client.models.operations.async.PeopleResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PeopleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PeopleRequest.class, new TypeReference<PeopleRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PeopleRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PeopleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PeopleResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PeopleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PeopleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PeopleResponse>() {})
                            .thenApply(res::withPeopleResponse);
                } else {
