...
public class GetDatasourceCredentialStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatasourceCredentialStatusRequest, GetDatasourceCredentialStatusResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatasourceCredentialStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatasourceCredentialStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatasourceCredentialStatusRequest request) {
        ...
        @Override
        public GetDatasourceCredentialStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatasourceCredentialStatusResponse.Builder resBuilder =
            ...
            GetDatasourceCredentialStatusResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatasourceCredentialStatusRequest, com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceCredentialStatusResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatasourceCredentialStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatasourceCredentialStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatasourceCredentialStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceCredentialStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceCredentialStatusResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceCredentialStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetDatasourceCredentialStatusResponse res = resBuilder.build();
