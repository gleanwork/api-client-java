...
public class Getchatapplication {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetchatapplicationRequest request) {
        ...
        @Override
        public GetchatapplicationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetChatApplicationResponse(Utils.unmarshal(response, new TypeReference<GetChatApplicationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetchatapplicationResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetChatApplicationResponse>() {})
                            .thenApply(res::withGetChatApplicationResponse);
                } else {
