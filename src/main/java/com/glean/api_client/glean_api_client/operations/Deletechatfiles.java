...
public class Deletechatfiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletechatfilesRequest, DeletechatfilesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletechatfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletechatfilesRequest.class, new TypeReference<DeletechatfilesRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletechatfilesRequest, com.glean.api_client.glean_api_client.models.operations.async.DeletechatfilesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletechatfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletechatfilesRequest.class, new TypeReference<DeletechatfilesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletechatfilesRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.DeletechatfilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.DeletechatfilesResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.DeletechatfilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.DeletechatfilesResponse res = resBuilder.build();
