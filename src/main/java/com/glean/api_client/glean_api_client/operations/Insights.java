...
import com.glean.api_client.glean_api_client.models.operations.InsightsRequest;
...
public class Insights {
    ...
    public static class Sync extends Base
            implements RequestOperation<InsightsRequest, InsightsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(InsightsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InsightsRequest.class, new TypeReference<InsightsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InsightsRequest request) {
        ...
        @Override
        public InsightsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            InsightsResponse.Builder resBuilder =
                    InsightsResponse
                            .builder()
            ...
            InsightsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInsightsResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.InsightsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<InsightsRequest, com.glean.api_client.glean_api_client.models.operations.async.InsightsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(InsightsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InsightsRequest.class, new TypeReference<InsightsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(InsightsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.InsightsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.InsightsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.InsightsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.InsightsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.InsightsResponse>() {})
                            .thenApply(res::withInsightsResponse);
                } else {
