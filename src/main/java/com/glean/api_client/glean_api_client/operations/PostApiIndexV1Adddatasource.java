...
public class PostApiIndexV1Adddatasource {
    ...
    public static class Sync extends Base
            implements RequestOperation<CustomDatasourceConfig, PostApiIndexV1AdddatasourceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CustomDatasourceConfig request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CustomDatasourceConfig>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CustomDatasourceConfig request) throws Exception {
        ...
        @Override
        public PostApiIndexV1AdddatasourceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1AdddatasourceResponse.Builder resBuilder =
            ...
            PostApiIndexV1AdddatasourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CustomDatasourceConfig, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1AdddatasourceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CustomDatasourceConfig request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CustomDatasourceConfig>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CustomDatasourceConfig request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1AdddatasourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1AdddatasourceResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1AdddatasourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1AdddatasourceResponse res = resBuilder.build();
