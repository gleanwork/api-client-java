...
public class GetAgent {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAgentRequest, com.glean.api_client.glean_api_client.models.operations.async.GetAgentResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAgentRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "403", "404", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetAgentResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetAgentResponse res = resBuilder.build();
