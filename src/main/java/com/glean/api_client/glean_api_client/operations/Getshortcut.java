...
public class Getshortcut {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetshortcutRequest, GetshortcutResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetshortcutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetshortcutRequest.class, new TypeReference<GetshortcutRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetshortcutRequest request) {
        ...
        @Override
        public GetshortcutResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetshortcutResponse.Builder resBuilder =
                    GetshortcutResponse
                            .builder()
            ...
            GetshortcutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetShortcutResponse(Utils.unmarshal(response, new TypeReference<GetShortcutResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetshortcutRequest, com.glean.api_client.glean_api_client.models.operations.async.GetshortcutResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetshortcutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetshortcutRequest.class, new TypeReference<GetshortcutRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetshortcutRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetshortcutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetshortcutResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetshortcutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetshortcutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetShortcutResponse>() {})
                            .thenApply(res::withGetShortcutResponse);
                } else {
