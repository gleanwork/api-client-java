...
public class PostApiIndexV1Getusercount {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserCountRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1GetusercountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetUserCountResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetUserCountResponse(out);
                    return res;
                } else {
