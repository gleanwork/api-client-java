...
public class Autocomplete {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AutocompleteRequest request) throws Exception {
        ...
        @Override
        public AutocompleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.glean.api_client.glean_api_client.models.components.AutocompleteResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAutocompleteResponse(out);
                    return res;
                } else {
