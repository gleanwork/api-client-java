...
public class Getpin {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetpinResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetpinResponse.Builder resBuilder =
                    GetpinResponse
                            .builder()
            ...
            GetpinResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetPinResponse(Utils.unmarshal(response, new TypeReference<GetPinResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetpinResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetpinResponse.Builder resBuilder =
            ...
            com.glean.api_client.glean_api_client.models.operations.async.GetpinResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPinResponse>() {})
                            .thenApply(res::withGetPinResponse);
                } else {
