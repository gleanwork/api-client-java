...
public class PlatformAgentsCancelRun {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/api/agents/{agent_id}/cancellations",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformAgentsCancelRunRequest, PlatformAgentsCancelRunResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformAgentsCancelRunRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsCancelRunRequest.class, new TypeReference<PlatformAgentsCancelRunRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformAgentsCancelRunRequest request) {
        ...
        @Override
        public PlatformAgentsCancelRunResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformAgentsCancelRunResponse.Builder resBuilder =
            ...
            PlatformAgentsCancelRunResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformAgentsCancelRunRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCancelRunResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformAgentsCancelRunRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsCancelRunRequest.class, new TypeReference<PlatformAgentsCancelRunRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformAgentsCancelRunRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCancelRunResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCancelRunResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCancelRunResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCancelRunResponse res = resBuilder.build();
