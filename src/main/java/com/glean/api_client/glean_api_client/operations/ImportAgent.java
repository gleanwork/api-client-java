...
import com.glean.api_client.glean_api_client.models.operations.ImportAgentRequest;
...
public class ImportAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<ImportAgentRequest, ImportAgentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ImportAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ImportAgentRequest.class, new TypeReference<ImportAgentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ImportAgentRequest request) {
        ...
        @Override
        public ImportAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ImportAgentResponse.Builder resBuilder =
                    ImportAgentResponse
                            .builder()
            ...
            ImportAgentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withImportAgentResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.ImportAgentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ImportAgentRequest, com.glean.api_client.glean_api_client.models.operations.async.ImportAgentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ImportAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ImportAgentRequest.class, new TypeReference<ImportAgentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ImportAgentRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ImportAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ImportAgentResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ImportAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ImportAgentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.ImportAgentResponse>() {})
                            .thenApply(res::withImportAgentResponse);
                } else {
