...
public class EditAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditAgentRequest, EditAgentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(EditAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditAgentRequest.class, new TypeReference<EditAgentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditAgentRequest request) {
        ...
        @Override
        public EditAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditAgentResponse.Builder resBuilder =
                    EditAgentResponse
                            .builder()
            ...
            EditAgentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditAgentRequest, com.glean.api_client.glean_api_client.models.operations.async.EditAgentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(EditAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditAgentRequest.class, new TypeReference<EditAgentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditAgentRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.EditAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.EditAgentResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.EditAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.EditAgentResponse res = resBuilder.build();
