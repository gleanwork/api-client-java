...
public class GetChatFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetChatFileRequest, GetChatFileResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetChatFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChatFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetChatFileRequest request) {
        ...
        @Override
        public GetChatFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetChatFileResponse.Builder resBuilder =
                    GetChatFileResponse
                            .builder()
            ...
            GetChatFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetChatFileRequest, com.glean.api_client.glean_api_client.models.operations.async.GetChatFileResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetChatFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChatFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetChatFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetChatFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetChatFileResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetChatFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            com.glean.api_client.glean_api_client.models.operations.async.GetChatFileResponse res = resBuilder.build();
