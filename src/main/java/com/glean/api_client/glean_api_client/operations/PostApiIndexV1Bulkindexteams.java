...
public class PostApiIndexV1Bulkindexteams {
    ...
    public static class Sync extends Base
            implements RequestOperation<BulkIndexTeamsRequest, PostApiIndexV1BulkindexteamsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(BulkIndexTeamsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BulkIndexTeamsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BulkIndexTeamsRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1BulkindexteamsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1BulkindexteamsResponse.Builder resBuilder =
            ...
            PostApiIndexV1BulkindexteamsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<BulkIndexTeamsRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexteamsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(BulkIndexTeamsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BulkIndexTeamsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BulkIndexTeamsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexteamsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexteamsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexteamsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1BulkindexteamsResponse res = resBuilder.build();
