...
public class Deletecollectionitem {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletecollectionitemRequest, DeletecollectionitemResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletecollectionitemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletecollectionitemRequest.class, new TypeReference<DeletecollectionitemRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletecollectionitemRequest request) {
        ...
        @Override
        public DeletecollectionitemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletecollectionitemResponse.Builder resBuilder =
            ...
            DeletecollectionitemResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteCollectionItemResponse(Utils.unmarshal(response, new TypeReference<DeleteCollectionItemResponse>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "422", "429", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletecollectionitemRequest, com.glean.api_client.glean_api_client.models.operations.async.DeletecollectionitemResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletecollectionitemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletecollectionitemRequest.class, new TypeReference<DeletecollectionitemRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletecollectionitemRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.DeletecollectionitemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.DeletecollectionitemResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.DeletecollectionitemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.DeletecollectionitemResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteCollectionItemResponse>() {})
                            .thenApply(res::withDeleteCollectionItemResponse);
                } else {
