...
public class PostApiIndexV1Processallmemberships {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends ProcessAllMembershipsRequest>, PostApiIndexV1ProcessallmembershipsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends ProcessAllMembershipsRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends ProcessAllMembershipsRequest>>() {});
        ...
        public PostApiIndexV1ProcessallmembershipsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            PostApiIndexV1ProcessallmembershipsResponse.Builder resBuilder =
            ...
            PostApiIndexV1ProcessallmembershipsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends ProcessAllMembershipsRequest>, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallmembershipsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends ProcessAllMembershipsRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends ProcessAllMembershipsRequest>>() {});
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallmembershipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallmembershipsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallmembershipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessallmembershipsResponse res = resBuilder.build();
