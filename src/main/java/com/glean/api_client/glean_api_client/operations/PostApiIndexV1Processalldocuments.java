...
public class PostApiIndexV1Processalldocuments {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends ProcessAllDocumentsRequest>, PostApiIndexV1ProcessalldocumentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends ProcessAllDocumentsRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends ProcessAllDocumentsRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends ProcessAllDocumentsRequest> request) throws Exception {
        ...
        @Override
        public PostApiIndexV1ProcessalldocumentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1ProcessalldocumentsResponse.Builder resBuilder =
            ...
            PostApiIndexV1ProcessalldocumentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends ProcessAllDocumentsRequest>, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessalldocumentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends ProcessAllDocumentsRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends ProcessAllDocumentsRequest>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends ProcessAllDocumentsRequest> request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessalldocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessalldocumentsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessalldocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1ProcessalldocumentsResponse res = resBuilder.build();
