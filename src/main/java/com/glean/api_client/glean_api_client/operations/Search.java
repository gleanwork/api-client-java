...
import com.glean.api_client.glean_api_client.models.operations.SearchRequest;
...
public class Search {
    ...
    public static class Sync extends Base
            implements RequestOperation<SearchRequest, SearchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SearchRequest.class, new TypeReference<SearchRequest>() {});
        ...
        public HttpResponse<InputStream> doRequest(SearchRequest request) {
            ...
            try {
                ...
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "408", "422", "429", "4XX", "5XX")) {
        ...
        public SearchResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSearchResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.SearchResponse>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "403", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw GleanDataError.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SearchRequest, com.glean.api_client.glean_api_client.models.operations.async.SearchResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(SearchRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "403", "408", "422", "429", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.SearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.SearchResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.SearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.SearchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.SearchResponse>() {})
                            .thenApply(res::withSearchResponse);
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "403", "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return GleanDataError.fromAsync(response)
