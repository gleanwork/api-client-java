...
public class Getchat {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetchatRequest, GetchatResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetchatRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetchatRequest.class, new TypeReference<GetchatRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetchatRequest request) {
        ...
        @Override
        public GetchatResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetchatResponse.Builder resBuilder =
                    GetchatResponse
                            .builder()
            ...
            GetchatResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetChatResponse(Utils.unmarshal(response, new TypeReference<GetChatResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetchatRequest, com.glean.api_client.glean_api_client.models.operations.async.GetchatResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetchatRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetchatRequest.class, new TypeReference<GetchatRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetchatRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetchatResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetchatResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetchatResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetchatResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetChatResponse>() {})
                            .thenApply(res::withGetChatResponse);
                } else {
