...
public class Feedback {
    ...
    public static class Sync extends Base
            implements RequestOperation<FeedbackRequest, FeedbackResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(FeedbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FeedbackRequest.class, new TypeReference<FeedbackRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FeedbackRequest, com.glean.api_client.glean_api_client.models.operations.async.FeedbackResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(FeedbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FeedbackRequest.class, new TypeReference<FeedbackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FeedbackRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.FeedbackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.FeedbackResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.FeedbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.FeedbackResponse res = resBuilder.build();
