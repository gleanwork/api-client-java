...
public class Recommendations {
    ...
    public static class Sync extends Base
            implements RequestOperation<RecommendationsRequest, RecommendationsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RecommendationsRequest request) {
        ...
        @Override
        public RecommendationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RecommendationsResponse.Builder resBuilder =
            ...
            RecommendationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResultsResponse(Utils.unmarshal(response, new TypeReference<ResultsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RecommendationsRequest, com.glean.api_client.glean_api_client.models.operations.async.RecommendationsResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RecommendationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.RecommendationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.RecommendationsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.RecommendationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.RecommendationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ResultsResponse>() {})
                            .thenApply(res::withResultsResponse);
                } else {
