...
public class Createcollection {
        ...
        public CreatecollectionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOneOf(Utils.unmarshal(response, new TypeReference<CreatecollectionResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.CreatecollectionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreatecollectionResponseBody>() {})
