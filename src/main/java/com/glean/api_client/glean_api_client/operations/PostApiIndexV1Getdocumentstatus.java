...
public class PostApiIndexV1Getdocumentstatus {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDocumentStatusRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1GetdocumentstatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetDocumentStatusResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetDocumentStatusResponse(out);
                    return res;
                } else {
