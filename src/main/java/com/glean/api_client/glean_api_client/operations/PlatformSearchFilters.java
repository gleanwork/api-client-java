...
public class PlatformSearchFilters {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSearchFiltersRequest, PlatformSearchFiltersResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSearchFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSearchFiltersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSearchFiltersRequest request) {
        ...
        @Override
        public PlatformSearchFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSearchFiltersResponse.Builder resBuilder =
            ...
            PlatformSearchFiltersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformSearchFiltersResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PlatformSearchFiltersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSearchFiltersRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchFiltersResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSearchFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSearchFiltersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSearchFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchFiltersResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchFiltersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformSearchFiltersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.PlatformSearchFiltersResponse>() {})
                            .thenApply(res::withPlatformSearchFiltersResponse);
                } else {
