...
public class PostApiIndexV1DeletegroupOperation implements RequestOperation<DeleteGroupRequest, PostApiIndexV1DeletegroupResponse> {
    ...
    @Override
    public PostApiIndexV1DeletegroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        PostApiIndexV1DeletegroupResponse.Builder resBuilder = 
        ...
        PostApiIndexV1DeletegroupResponse res = resBuilder.build();
