...
public class Listfindingsexports {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListfindingsexportsResponse> {
        ...
        @Override
        public ListfindingsexportsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListfindingsexportsResponse.Builder resBuilder =
            ...
            ListfindingsexportsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListDlpFindingsExportsResponse(Utils.unmarshal(response, new TypeReference<ListDlpFindingsExportsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.glean.api_client.glean_api_client.models.operations.async.ListfindingsexportsResponse> {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ListfindingsexportsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ListfindingsexportsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ListfindingsexportsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ListfindingsexportsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListDlpFindingsExportsResponse>() {})
                            .thenApply(res::withListDlpFindingsExportsResponse);
                } else {
