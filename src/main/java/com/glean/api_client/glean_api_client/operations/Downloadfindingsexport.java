...
public class Downloadfindingsexport {
    ...
    public static class Sync extends Base
            implements RequestOperation<DownloadfindingsexportRequest, DownloadfindingsexportResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DownloadfindingsexportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DownloadfindingsexportRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DownloadfindingsexportRequest request) {
        ...
        @Override
        public DownloadfindingsexportResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DownloadfindingsexportResponse.Builder resBuilder =
            ...
            DownloadfindingsexportResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DownloadfindingsexportRequest, com.glean.api_client.glean_api_client.models.operations.async.DownloadfindingsexportResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DownloadfindingsexportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DownloadfindingsexportRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DownloadfindingsexportRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.DownloadfindingsexportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.DownloadfindingsexportResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.DownloadfindingsexportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.DownloadfindingsexportResponse res = resBuilder.build();
