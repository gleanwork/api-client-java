...
public class GetToolServerAuthStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetToolServerAuthStatusRequest, GetToolServerAuthStatusResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetToolServerAuthStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetToolServerAuthStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetToolServerAuthStatusRequest request) {
        ...
        @Override
        public GetToolServerAuthStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetToolServerAuthStatusResponse.Builder resBuilder =
            ...
            GetToolServerAuthStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withToolServerAuthStatusResponse(Utils.unmarshal(response, new TypeReference<ToolServerAuthStatusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetToolServerAuthStatusRequest, com.glean.api_client.glean_api_client.models.operations.async.GetToolServerAuthStatusResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetToolServerAuthStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetToolServerAuthStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetToolServerAuthStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetToolServerAuthStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetToolServerAuthStatusResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetToolServerAuthStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetToolServerAuthStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ToolServerAuthStatusResponse>() {})
                            .thenApply(res::withToolServerAuthStatusResponse);
                } else {
