...
public class PostApiIndexV1Rotatetoken {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<PostApiIndexV1RotatetokenResponse> {
        ...
        @Override
        public PostApiIndexV1RotatetokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRotateTokenResponse(Utils.unmarshal(response, new TypeReference<RotateTokenResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1RotatetokenResponse> {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1RotatetokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1RotatetokenResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1RotatetokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1RotatetokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RotateTokenResponse>() {})
                            .thenApply(res::withRotateTokenResponse);
                } else {
