...
public class Pin {
    ...
    public static class Sync extends Base
            implements RequestOperation<PinRequest, PinResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PinRequest request) {
        ...
        @Override
        public PinResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PinResponse.Builder resBuilder =
                    PinResponse
                            .builder()
            ...
            PinResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPinDocument(Utils.unmarshal(response, new TypeReference<PinDocument>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PinRequest, com.glean.api_client.glean_api_client.models.operations.async.PinResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PinRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PinResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PinResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PinResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PinResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PinDocument>() {})
                            .thenApply(res::withPinDocument);
                } else {
