...
public class Setdocvisibility {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDocumentVisibilityOverridesRequest request) throws Exception {
        ...
        @Override
        public SetdocvisibilityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    UpdateDocumentVisibilityOverridesResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUpdateDocumentVisibilityOverridesResponse(out);
                    return res;
                } else {
