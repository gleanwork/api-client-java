...
public class Setdocvisibility {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDocumentVisibilityOverridesRequest, SetdocvisibilityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDocumentVisibilityOverridesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdateDocumentVisibilityOverridesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDocumentVisibilityOverridesRequest request) {
        ...
        @Override
        public SetdocvisibilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetdocvisibilityResponse.Builder resBuilder =
            ...
            SetdocvisibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return res.withUpdateDocumentVisibilityOverridesResponse(Utils.unmarshal(response, new TypeReference<UpdateDocumentVisibilityOverridesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDocumentVisibilityOverridesRequest, com.glean.api_client.glean_api_client.models.operations.async.SetdocvisibilityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDocumentVisibilityOverridesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdateDocumentVisibilityOverridesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDocumentVisibilityOverridesRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.SetdocvisibilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.SetdocvisibilityResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.SetdocvisibilityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.SetdocvisibilityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateDocumentVisibilityOverridesResponse>() {})
                            .thenApply(res::withUpdateDocumentVisibilityOverridesResponse);
                } else {
