...
public class PlatformSkillsCreateVersion {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSkillsCreateVersionRequest, PlatformSkillsCreateVersionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSkillsCreateVersionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsCreateVersionRequest.class, new TypeReference<PlatformSkillsCreateVersionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSkillsCreateVersionRequest request) {
        ...
        @Override
        public PlatformSkillsCreateVersionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSkillsCreateVersionResponse.Builder resBuilder =
                    PlatformSkillsCreateVersionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PlatformSkillsCreateVersionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformSkillVersionCreateResponse(Utils.unmarshal(response, new TypeReference<PlatformSkillVersionCreateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSkillsCreateVersionRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsCreateVersionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSkillsCreateVersionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsCreateVersionRequest.class, new TypeReference<PlatformSkillsCreateVersionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSkillsCreateVersionRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsCreateVersionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsCreateVersionResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsCreateVersionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsCreateVersionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformSkillVersionCreateResponse>() {})
                            .thenApply(res::withPlatformSkillVersionCreateResponse);
                } else {
