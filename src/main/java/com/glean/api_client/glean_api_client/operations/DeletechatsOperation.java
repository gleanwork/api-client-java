...
public class DeletechatsOperation implements RequestOperation<DeletechatsRequest, DeletechatsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeletechatsOperation(SDKConfiguration sdkConfiguration) {
