...
public class PostApiIndexV1Deletedocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDocumentRequest, PostApiIndexV1DeletedocumentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DeleteDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDocumentRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1DeletedocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1DeletedocumentResponse.Builder resBuilder =
            ...
            PostApiIndexV1DeletedocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDocumentRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeletedocumentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DeleteDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeletedocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeletedocumentResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeletedocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DeletedocumentResponse res = resBuilder.build();
