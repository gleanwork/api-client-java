...
public class Summarize {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SummarizeRequest request) throws Exception {
        ...
        @Override
        public SummarizeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.glean.api_client.glean_api_client.models.components.SummarizeResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSummarizeResponse(out);
                    return res;
                } else {
