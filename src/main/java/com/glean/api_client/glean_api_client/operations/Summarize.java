...
import com.glean.api_client.glean_api_client.models.operations.SummarizeRequest;
...
public class Summarize {
    ...
    public static class Sync extends Base
            implements RequestOperation<SummarizeRequest, SummarizeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SummarizeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SummarizeRequest.class, new TypeReference<SummarizeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SummarizeRequest request) {
        ...
        @Override
        public SummarizeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SummarizeResponse.Builder resBuilder =
                    SummarizeResponse
                            .builder()
            ...
            SummarizeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSummarizeResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.SummarizeResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SummarizeRequest, com.glean.api_client.glean_api_client.models.operations.async.SummarizeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(SummarizeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SummarizeRequest.class, new TypeReference<SummarizeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SummarizeRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.SummarizeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.SummarizeResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.SummarizeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.SummarizeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.SummarizeResponse>() {})
                            .thenApply(res::withSummarizeResponse);
                } else {
