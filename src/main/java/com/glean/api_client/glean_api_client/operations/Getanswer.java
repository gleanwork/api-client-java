...
public class Getanswer {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetanswerRequest, GetanswerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetanswerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetanswerRequest.class, new TypeReference<GetanswerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetanswerRequest request) {
        ...
        @Override
        public GetanswerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetanswerResponse.Builder resBuilder =
                    GetanswerResponse
                            .builder()
            ...
            GetanswerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAnswerResponse(Utils.unmarshal(response, new TypeReference<GetAnswerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetanswerRequest, com.glean.api_client.glean_api_client.models.operations.async.GetanswerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetanswerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetanswerRequest.class, new TypeReference<GetanswerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetanswerRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetanswerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetanswerResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetanswerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetanswerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAnswerResponse>() {})
                            .thenApply(res::withGetAnswerResponse);
                } else {
