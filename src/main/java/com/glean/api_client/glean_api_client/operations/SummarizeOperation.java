...
public class SummarizeOperation implements RequestOperation<SummarizeRequest, SummarizeResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public SummarizeOperation(SDKConfiguration sdkConfiguration) {
