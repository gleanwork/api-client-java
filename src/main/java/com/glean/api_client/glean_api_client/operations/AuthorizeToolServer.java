...
import com.glean.api_client.glean_api_client.models.operations.AuthorizeToolServerRequest;
...
public class AuthorizeToolServer {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthorizeToolServerRequest, AuthorizeToolServerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AuthorizeToolServerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AuthorizeToolServerRequest.class, new TypeReference<AuthorizeToolServerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AuthorizeToolServerRequest request) {
        ...
        @Override
        public AuthorizeToolServerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AuthorizeToolServerResponse.Builder resBuilder =
            ...
            AuthorizeToolServerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAuthorizeToolServerResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.AuthorizeToolServerResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AuthorizeToolServerRequest, com.glean.api_client.glean_api_client.models.operations.async.AuthorizeToolServerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AuthorizeToolServerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AuthorizeToolServerRequest.class, new TypeReference<AuthorizeToolServerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AuthorizeToolServerRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.AuthorizeToolServerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.AuthorizeToolServerResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.AuthorizeToolServerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.AuthorizeToolServerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.AuthorizeToolServerResponse>() {})
                            .thenApply(res::withAuthorizeToolServerResponse);
                } else {
