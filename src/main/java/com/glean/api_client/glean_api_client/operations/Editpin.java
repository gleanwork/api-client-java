...
public class Editpin {
    ...
    public static class Sync extends Base
        ...
        @Override
        public EditpinResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditpinResponse.Builder resBuilder =
                    EditpinResponse
                            .builder()
            ...
            EditpinResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.EditpinResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.EditpinResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.EditpinResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.EditpinResponse res = resBuilder.build();
