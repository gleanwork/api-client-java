...
public class PlatformTriggerPresetsGet {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformTriggerPresetsGetRequest, PlatformTriggerPresetsGetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformTriggerPresetsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggerPresetsGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformTriggerPresetsGetRequest request) {
        ...
        @Override
        public PlatformTriggerPresetsGetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformTriggerPresetsGetResponse.Builder resBuilder =
            ...
            PlatformTriggerPresetsGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformTriggerPresetGetResponse(Utils.unmarshal(response, new TypeReference<PlatformTriggerPresetGetResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformTriggerPresetsGetRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformTriggerPresetsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformTriggerPresetsGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformTriggerPresetsGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsGetResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformTriggerPresetsGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformTriggerPresetGetResponse>() {})
                            .thenApply(res::withPlatformTriggerPresetGetResponse);
                } else {
