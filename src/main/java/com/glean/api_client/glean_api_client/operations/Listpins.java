...
public class Listpins {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListpinsRequest, ListpinsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListpinsRequest request) {
        ...
        @Override
        public ListpinsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListPinsResponse(Utils.unmarshal(response, new TypeReference<ListPinsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListpinsRequest, com.glean.api_client.glean_api_client.models.operations.async.ListpinsResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListpinsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ListpinsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ListpinsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ListpinsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ListpinsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListPinsResponse>() {})
                            .thenApply(res::withListPinsResponse);
                } else {
