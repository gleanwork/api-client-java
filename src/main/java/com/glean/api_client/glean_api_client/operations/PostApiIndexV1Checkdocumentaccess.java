...
public class PostApiIndexV1Checkdocumentaccess {
    ...
    public static class Sync extends Base
            implements RequestOperation<CheckDocumentAccessRequest, PostApiIndexV1CheckdocumentaccessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CheckDocumentAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CheckDocumentAccessRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CheckDocumentAccessRequest request) {
        ...
        @Override
        public PostApiIndexV1CheckdocumentaccessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1CheckdocumentaccessResponse.Builder resBuilder =
            ...
            PostApiIndexV1CheckdocumentaccessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCheckDocumentAccessResponse(Utils.unmarshal(response, new TypeReference<CheckDocumentAccessResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CheckDocumentAccessRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1CheckdocumentaccessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CheckDocumentAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CheckDocumentAccessRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CheckDocumentAccessRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1CheckdocumentaccessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1CheckdocumentaccessResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1CheckdocumentaccessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1CheckdocumentaccessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CheckDocumentAccessResponse>() {})
                            .thenApply(res::withCheckDocumentAccessResponse);
                } else {
