...
public class PostApiIndexV1Checkdocumentaccess {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CheckDocumentAccessRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1CheckdocumentaccessResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CheckDocumentAccessResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCheckDocumentAccessResponse(out);
                    return res;
                } else {
