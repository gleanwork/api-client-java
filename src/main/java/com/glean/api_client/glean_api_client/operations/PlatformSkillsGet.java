...
public class PlatformSkillsGet {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformSkillsGetRequest, PlatformSkillsGetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformSkillsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformSkillsGetRequest request) {
        ...
        @Override
        public PlatformSkillsGetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformSkillsGetResponse.Builder resBuilder =
            ...
            PlatformSkillsGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformSkillGetResponse(Utils.unmarshal(response, new TypeReference<PlatformSkillGetResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformSkillsGetRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformSkillsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformSkillsGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformSkillsGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformSkillsGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformSkillGetResponse>() {})
                            .thenApply(res::withPlatformSkillGetResponse);
                } else {
