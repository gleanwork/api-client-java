...
public class Updateshortcut {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateshortcutRequest, UpdateshortcutResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateshortcutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateshortcutRequest.class, new TypeReference<UpdateshortcutRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateshortcutRequest request) {
        ...
        @Override
        public UpdateshortcutResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateshortcutResponse.Builder resBuilder =
            ...
            UpdateshortcutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUpdateShortcutResponse(Utils.unmarshal(response, new TypeReference<UpdateShortcutResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateshortcutRequest, com.glean.api_client.glean_api_client.models.operations.async.UpdateshortcutResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateshortcutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateshortcutRequest.class, new TypeReference<UpdateshortcutRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateshortcutRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.UpdateshortcutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.UpdateshortcutResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.UpdateshortcutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.UpdateshortcutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateShortcutResponse>() {})
                            .thenApply(res::withUpdateShortcutResponse);
                } else {
