...
public class PostApiIndexV1Indexemployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<IndexEmployeeRequest, PostApiIndexV1IndexemployeeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(IndexEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<IndexEmployeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IndexEmployeeRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1IndexemployeeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1IndexemployeeResponse.Builder resBuilder =
            ...
            PostApiIndexV1IndexemployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IndexEmployeeRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexemployeeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(IndexEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<IndexEmployeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IndexEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexemployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexemployeeResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexemployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexemployeeResponse res = resBuilder.build();
