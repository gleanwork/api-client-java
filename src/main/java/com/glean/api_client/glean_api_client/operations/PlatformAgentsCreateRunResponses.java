...
public class PlatformAgentsCreateRunResponses {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformAgentsCreateRunResponsesRequest, PlatformAgentsCreateRunResponsesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformAgentsCreateRunResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsCreateRunResponsesRequest.class, new TypeReference<PlatformAgentsCreateRunResponsesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformAgentsCreateRunResponsesRequest request) {
        ...
        @Override
        public PlatformAgentsCreateRunResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformAgentsCreateRunResponsesResponse.Builder resBuilder =
            ...
            PlatformAgentsCreateRunResponsesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformAgentsCreateRunResponsesRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponsesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformAgentsCreateRunResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsCreateRunResponsesRequest.class, new TypeReference<PlatformAgentsCreateRunResponsesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformAgentsCreateRunResponsesRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponsesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponsesResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponsesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsCreateRunResponsesResponse res = resBuilder.build();
