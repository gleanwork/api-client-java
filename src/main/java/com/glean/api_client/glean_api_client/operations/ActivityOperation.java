...
public class ActivityOperation implements RequestOperation<Activity, ActivityResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Activity request) throws Exception {
