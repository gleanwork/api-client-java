...
import com.glean.api_client.glean_api_client.models.operations.MessagesRequest;
...
public class Messages {
    ...
    public static class Sync extends Base
            implements RequestOperation<MessagesRequest, MessagesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(MessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagesRequest.class, new TypeReference<MessagesRequest>() {});
        ...
        public MessagesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            MessagesResponse.Builder resBuilder =
                    MessagesResponse
                            .builder()
            ...
            MessagesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MessagesRequest, com.glean.api_client.glean_api_client.models.operations.async.MessagesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(MessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MessagesRequest.class, new TypeReference<MessagesRequest>() {});
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.MessagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.MessagesResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.MessagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.MessagesResponse res = resBuilder.build();
