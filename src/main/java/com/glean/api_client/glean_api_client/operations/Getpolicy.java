...
public class Getpolicy {
        ...
        public GetpolicyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetDlpReportResponse(Utils.unmarshal(response, new TypeReference<GetDlpReportResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetpolicyResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDlpReportResponse>() {})
                            .thenApply(res::withGetDlpReportResponse);
                } else {
