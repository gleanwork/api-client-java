...
public class Listshortcuts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShortcutsPaginatedRequest request) throws Exception {
        ...
        @Override
        public ListshortcutsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ListShortcutsPaginatedResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withListShortcutsPaginatedResponse(out);
                    return res;
                } else {
