...
public class Listshortcuts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShortcutsPaginatedRequest, ListshortcutsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShortcutsPaginatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ListShortcutsPaginatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShortcutsPaginatedRequest request) {
        ...
        @Override
        public ListshortcutsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListshortcutsResponse.Builder resBuilder =
            ...
            ListshortcutsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListShortcutsPaginatedResponse(Utils.unmarshal(response, new TypeReference<ListShortcutsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShortcutsPaginatedRequest, com.glean.api_client.glean_api_client.models.operations.async.ListshortcutsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShortcutsPaginatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ListShortcutsPaginatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShortcutsPaginatedRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.ListshortcutsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.ListshortcutsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.ListshortcutsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.ListshortcutsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListShortcutsPaginatedResponse>() {})
                            .thenApply(res::withListShortcutsPaginatedResponse);
                } else {
