...
public class PostApiIndexV1Indexdocuments {
    ...
    public static class Sync extends Base
            implements RequestOperation<IndexDocumentsRequest, PostApiIndexV1IndexdocumentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(IndexDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<IndexDocumentsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IndexDocumentsRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1IndexdocumentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1IndexdocumentsResponse.Builder resBuilder =
            ...
            PostApiIndexV1IndexdocumentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IndexDocumentsRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexdocumentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(IndexDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<IndexDocumentsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IndexDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexdocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexdocumentsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexdocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1IndexdocumentsResponse res = resBuilder.build();
