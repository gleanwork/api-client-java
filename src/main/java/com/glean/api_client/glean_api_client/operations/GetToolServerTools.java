...
public class GetToolServerTools {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetToolServerToolsRequest, GetToolServerToolsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetToolServerToolsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetToolServerToolsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetToolServerToolsRequest request) {
        ...
        @Override
        public GetToolServerToolsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetToolServerToolsResponse.Builder resBuilder =
                    GetToolServerToolsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetToolServerToolsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withToolDefinitionsResponse(Utils.unmarshal(response, new TypeReference<ToolDefinitionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetToolServerToolsRequest, com.glean.api_client.glean_api_client.models.operations.async.GetToolServerToolsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetToolServerToolsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetToolServerToolsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetToolServerToolsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetToolServerToolsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetToolServerToolsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetToolServerToolsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetToolServerToolsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ToolDefinitionsResponse>() {})
                            .thenApply(res::withToolDefinitionsResponse);
                } else {
