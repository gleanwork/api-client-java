...
public class Createauthtoken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public CreateauthtokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateAuthTokenResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateAuthTokenResponse(out);
                    return res;
                } else {
