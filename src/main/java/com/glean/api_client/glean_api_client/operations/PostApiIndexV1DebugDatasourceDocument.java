...
public class PostApiIndexV1DebugDatasourceDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostApiIndexV1DebugDatasourceDocumentRequest, PostApiIndexV1DebugDatasourceDocumentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostApiIndexV1DebugDatasourceDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostApiIndexV1DebugDatasourceDocumentRequest.class, new TypeReference<PostApiIndexV1DebugDatasourceDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostApiIndexV1DebugDatasourceDocumentRequest request) {
        ...
        @Override
        public PostApiIndexV1DebugDatasourceDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1DebugDatasourceDocumentResponse.Builder resBuilder =
            ...
            PostApiIndexV1DebugDatasourceDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return res.withDebugDocumentResponse(Utils.unmarshal(response, new TypeReference<DebugDocumentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostApiIndexV1DebugDatasourceDocumentRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceDocumentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostApiIndexV1DebugDatasourceDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostApiIndexV1DebugDatasourceDocumentRequest.class, new TypeReference<PostApiIndexV1DebugDatasourceDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostApiIndexV1DebugDatasourceDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceDocumentResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DebugDocumentResponse>() {})
                            .thenApply(res::withDebugDocumentResponse);
                } else {
