...
public class PostApiIndexV1DebugDatasourceDocument {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostApiIndexV1DebugDatasourceDocumentRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1DebugDatasourceDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    DebugDocumentResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDebugDocumentResponse(out);
                    return res;
                } else {
