...
public class Createpolicy {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateDlpReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateDlpReportRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDlpReportRequest request) {
        ...
        public CreatepolicyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return res.withCreateDlpReportResponse(Utils.unmarshal(response, new TypeReference<CreateDlpReportResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDlpReportRequest, com.glean.api_client.glean_api_client.models.operations.async.CreatepolicyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDlpReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateDlpReportRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDlpReportRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.CreatepolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.CreatepolicyResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.CreatepolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.CreatepolicyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateDlpReportResponse>() {})
                            .thenApply(res::withCreateDlpReportResponse);
                } else {
