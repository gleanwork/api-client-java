...
public class Updateannouncement {
    ...
    public static class Sync extends Base
        ...
        @Override
        public UpdateannouncementResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateannouncementResponse.Builder resBuilder =
            ...
            UpdateannouncementResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.UpdateannouncementResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.UpdateannouncementResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.UpdateannouncementResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.UpdateannouncementResponse res = resBuilder.build();
