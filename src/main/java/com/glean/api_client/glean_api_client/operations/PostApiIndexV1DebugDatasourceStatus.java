...
public class PostApiIndexV1DebugDatasourceStatus {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostApiIndexV1DebugDatasourceStatusRequest request) throws Exception {
        ...
        @Override
        public PostApiIndexV1DebugDatasourceStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json; charset=UTF-8")) {
                    DebugDatasourceStatusResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDebugDatasourceStatusResponse(out);
                    return res;
                } else {
