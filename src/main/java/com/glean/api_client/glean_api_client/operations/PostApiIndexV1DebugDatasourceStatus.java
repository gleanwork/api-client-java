...
public class PostApiIndexV1DebugDatasourceStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostApiIndexV1DebugDatasourceStatusRequest, PostApiIndexV1DebugDatasourceStatusResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostApiIndexV1DebugDatasourceStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostApiIndexV1DebugDatasourceStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostApiIndexV1DebugDatasourceStatusRequest request) {
        ...
        @Override
        public PostApiIndexV1DebugDatasourceStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostApiIndexV1DebugDatasourceStatusResponse.Builder resBuilder =
            ...
            PostApiIndexV1DebugDatasourceStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDebugDatasourceStatusResponse(Utils.unmarshal(response, new TypeReference<DebugDatasourceStatusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostApiIndexV1DebugDatasourceStatusRequest, com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceStatusResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostApiIndexV1DebugDatasourceStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostApiIndexV1DebugDatasourceStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostApiIndexV1DebugDatasourceStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceStatusResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PostApiIndexV1DebugDatasourceStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DebugDatasourceStatusResponse>() {})
                            .thenApply(res::withDebugDatasourceStatusResponse);
                } else {
