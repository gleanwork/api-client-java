...
import com.glean.api_client.glean_api_client.models.operations.AuthorizeActionRequest;
...
public class AuthorizeAction {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthorizeActionRequest, AuthorizeActionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AuthorizeActionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AuthorizeActionRequest.class, new TypeReference<AuthorizeActionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AuthorizeActionRequest request) {
        ...
        @Override
        public AuthorizeActionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AuthorizeActionResponse.Builder resBuilder =
            ...
            AuthorizeActionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAuthorizeActionResponse(Utils.unmarshal(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.AuthorizeActionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AuthorizeActionRequest, com.glean.api_client.glean_api_client.models.operations.async.AuthorizeActionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AuthorizeActionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AuthorizeActionRequest.class, new TypeReference<AuthorizeActionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AuthorizeActionRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.AuthorizeActionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.AuthorizeActionResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.AuthorizeActionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.AuthorizeActionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.glean.api_client.glean_api_client.models.components.AuthorizeActionResponse>() {})
                            .thenApply(res::withAuthorizeActionResponse);
                } else {
