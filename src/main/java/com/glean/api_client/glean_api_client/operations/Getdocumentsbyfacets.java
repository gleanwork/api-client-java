...
public class Getdocumentsbyfacets {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetdocumentsbyfacetsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetdocumentsbyfacetsResponse.Builder resBuilder =
            ...
            GetdocumentsbyfacetsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetDocumentsByFacetsResponse(Utils.unmarshal(response, new TypeReference<GetDocumentsByFacetsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetdocumentsbyfacetsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetdocumentsbyfacetsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetdocumentsbyfacetsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetdocumentsbyfacetsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDocumentsByFacetsResponse>() {})
                            .thenApply(res::withGetDocumentsByFacetsResponse);
                } else {
