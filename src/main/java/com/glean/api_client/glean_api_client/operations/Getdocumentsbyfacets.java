...
public class Getdocumentsbyfacets {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends GetDocumentsByFacetsRequest> request) throws Exception {
        ...
        @Override
        public GetdocumentsbyfacetsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetDocumentsByFacetsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetDocumentsByFacetsResponse(out);
                    return res;
                } else {
