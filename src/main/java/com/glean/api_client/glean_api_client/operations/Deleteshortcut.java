...
public class Deleteshortcut {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteShortcutRequest request) throws Exception {
        ...
        @Override
        public DeleteshortcutResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteshortcutResponse.Builder resBuilder =
            ...
            DeleteshortcutResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.DeleteshortcutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.DeleteshortcutResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.DeleteshortcutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.DeleteshortcutResponse res = resBuilder.build();
