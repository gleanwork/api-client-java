...
public class Editanswer {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditanswerRequest, EditanswerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(EditanswerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditanswerRequest.class, new TypeReference<EditanswerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditanswerRequest request) {
        ...
        @Override
        public EditanswerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditanswerResponse.Builder resBuilder =
                    EditanswerResponse
                            .builder()
            ...
            EditanswerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnswer(Utils.unmarshal(response, new TypeReference<Answer>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditanswerRequest, com.glean.api_client.glean_api_client.models.operations.async.EditanswerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(EditanswerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditanswerRequest.class, new TypeReference<EditanswerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditanswerRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.EditanswerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.EditanswerResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.EditanswerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.EditanswerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Answer>() {})
                            .thenApply(res::withAnswer);
                } else {
