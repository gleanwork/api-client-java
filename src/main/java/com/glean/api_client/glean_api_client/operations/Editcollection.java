...
public class Editcollection {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditCollectionRequest request) throws Exception {
        ...
        @Override
        public EditcollectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EditCollectionResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEditCollectionResponse(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.EditcollectionResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.glean.api_client.glean_api_client.models.errors.async.CollectionError out;
                        try {
