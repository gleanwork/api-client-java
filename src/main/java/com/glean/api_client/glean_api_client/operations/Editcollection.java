...
public class Editcollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditcollectionRequest, EditcollectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(EditcollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditcollectionRequest.class, new TypeReference<EditcollectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditcollectionRequest request) {
        ...
        @Override
        public EditcollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditcollectionResponse.Builder resBuilder =
            ...
            EditcollectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEditCollectionResponse(Utils.unmarshal(response, new TypeReference<EditCollectionResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditcollectionRequest, com.glean.api_client.glean_api_client.models.operations.async.EditcollectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(EditcollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditcollectionRequest.class, new TypeReference<EditcollectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditcollectionRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.EditcollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.EditcollectionResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.EditcollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.EditcollectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EditCollectionResponse>() {})
                            .thenApply(res::withEditCollectionResponse);
                } else {
