...
public class PlatformAgentsGetSchemas {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformAgentsGetSchemasRequest, PlatformAgentsGetSchemasResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformAgentsGetSchemasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsGetSchemasRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformAgentsGetSchemasRequest request) {
        ...
        @Override
        public PlatformAgentsGetSchemasResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformAgentsGetSchemasResponse.Builder resBuilder =
            ...
            PlatformAgentsGetSchemasResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlatformAgentSchemasResponse(Utils.unmarshal(response, new TypeReference<PlatformAgentSchemasResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformAgentsGetSchemasRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetSchemasResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformAgentsGetSchemasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsGetSchemasRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformAgentsGetSchemasRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetSchemasResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetSchemasResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetSchemasResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetSchemasResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlatformAgentSchemasResponse>() {})
                            .thenApply(res::withPlatformAgentSchemasResponse);
                } else {
