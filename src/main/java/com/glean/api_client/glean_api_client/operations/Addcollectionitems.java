...
public class Addcollectionitems {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AddcollectionitemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddcollectionitemsRequest.class, new TypeReference<AddcollectionitemsRequest>() {});
        ...
        public AddcollectionitemsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAddCollectionItemsResponse(Utils.unmarshal(response, new TypeReference<AddCollectionItemsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddcollectionitemsRequest, com.glean.api_client.glean_api_client.models.operations.async.AddcollectionitemsResponse> {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.AddcollectionitemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.AddcollectionitemsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.AddcollectionitemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.AddcollectionitemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AddCollectionItemsResponse>() {})
                            .thenApply(res::withAddCollectionItemsResponse);
                } else {
