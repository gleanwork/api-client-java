...
public class Addcollectionitems {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AddCollectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AddCollectionItemsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddCollectionItemsRequest request) throws Exception {
        ...
        @Override
        public AddcollectionitemsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AddCollectionItemsResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAddCollectionItemsResponse(out);
                    return res;
                } else {
