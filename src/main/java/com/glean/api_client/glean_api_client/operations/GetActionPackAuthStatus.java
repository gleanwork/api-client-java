...
public class GetActionPackAuthStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetActionPackAuthStatusRequest, GetActionPackAuthStatusResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetActionPackAuthStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActionPackAuthStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetActionPackAuthStatusRequest request) {
        ...
        @Override
        public GetActionPackAuthStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetActionPackAuthStatusResponse.Builder resBuilder =
            ...
            GetActionPackAuthStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withActionPackAuthStatusResponse(Utils.unmarshal(response, new TypeReference<ActionPackAuthStatusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetActionPackAuthStatusRequest, com.glean.api_client.glean_api_client.models.operations.async.GetActionPackAuthStatusResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetActionPackAuthStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActionPackAuthStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetActionPackAuthStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetActionPackAuthStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetActionPackAuthStatusResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetActionPackAuthStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetActionPackAuthStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ActionPackAuthStatusResponse>() {})
                            .thenApply(res::withActionPackAuthStatusResponse);
                } else {
