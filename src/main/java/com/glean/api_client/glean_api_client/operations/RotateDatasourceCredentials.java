...
import com.glean.api_client.glean_api_client.models.operations.RotateDatasourceCredentialsRequest;
...
public class RotateDatasourceCredentials {
    ...
    public static class Sync extends Base
            implements RequestOperation<RotateDatasourceCredentialsRequest, RotateDatasourceCredentialsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RotateDatasourceCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RotateDatasourceCredentialsRequest.class, new TypeReference<RotateDatasourceCredentialsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RotateDatasourceCredentialsRequest request) {
        ...
        @Override
        public RotateDatasourceCredentialsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RotateDatasourceCredentialsResponse.Builder resBuilder =
            ...
            RotateDatasourceCredentialsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatasourceCredentialStatusResponse(Utils.unmarshal(response, new TypeReference<DatasourceCredentialStatusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RotateDatasourceCredentialsRequest, com.glean.api_client.glean_api_client.models.operations.async.RotateDatasourceCredentialsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RotateDatasourceCredentialsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RotateDatasourceCredentialsRequest.class, new TypeReference<RotateDatasourceCredentialsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RotateDatasourceCredentialsRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.RotateDatasourceCredentialsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.RotateDatasourceCredentialsResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.RotateDatasourceCredentialsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.RotateDatasourceCredentialsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DatasourceCredentialStatusResponse>() {})
                            .thenApply(res::withDatasourceCredentialStatusResponse);
                } else {
