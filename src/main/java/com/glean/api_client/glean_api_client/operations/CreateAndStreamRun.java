...
public class CreateAndStreamRun {
    ...
    public static class Sync extends Base
            implements RequestOperation<AgentRunCreate, CreateAndStreamRunResponse> {
        ...
        public CreateAndStreamRunResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateAndStreamRunResponse.Builder resBuilder =
            ...
            CreateAndStreamRunResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AgentRunCreate, com.glean.api_client.glean_api_client.models.operations.async.CreateAndStreamRunResponse> {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.CreateAndStreamRunResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.CreateAndStreamRunResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.CreateAndStreamRunResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.CreateAndStreamRunResponse res = resBuilder.build();
