...
public class PlatformAgentsGetRun {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlatformAgentsGetRunRequest, PlatformAgentsGetRunResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PlatformAgentsGetRunRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsGetRunRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlatformAgentsGetRunRequest request) {
        ...
        @Override
        public PlatformAgentsGetRunResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlatformAgentsGetRunResponse.Builder resBuilder =
            ...
            PlatformAgentsGetRunResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlatformAgentsGetRunRequest, com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetRunResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PlatformAgentsGetRunRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlatformAgentsGetRunRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlatformAgentsGetRunRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetRunResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetRunResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetRunResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.PlatformAgentsGetRunResponse res = resBuilder.build();
