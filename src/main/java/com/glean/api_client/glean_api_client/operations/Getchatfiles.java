...
public class Getchatfiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetchatfilesRequest, GetchatfilesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetchatfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetchatfilesRequest.class, new TypeReference<GetchatfilesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetchatfilesRequest request) {
        ...
        @Override
        public GetchatfilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetchatfilesResponse.Builder resBuilder =
            ...
            GetchatfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetChatFilesResponse(Utils.unmarshal(response, new TypeReference<GetChatFilesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetchatfilesRequest, com.glean.api_client.glean_api_client.models.operations.async.GetchatfilesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetchatfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetchatfilesRequest.class, new TypeReference<GetchatfilesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetchatfilesRequest request) {
        ...
        @Override
        public CompletableFuture<com.glean.api_client.glean_api_client.models.operations.async.GetchatfilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.glean.api_client.glean_api_client.models.operations.async.GetchatfilesResponse.Builder resBuilder =
                    com.glean.api_client.glean_api_client.models.operations.async.GetchatfilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.glean.api_client.glean_api_client.models.operations.async.GetchatfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetChatFilesResponse>() {})
                            .thenApply(res::withGetChatFilesResponse);
                } else {
