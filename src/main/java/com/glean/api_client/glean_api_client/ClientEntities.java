...
public class ClientEntities {
    ...
    private final AsyncClientEntities asyncSDK;

    ClientEntities(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.asyncSDK = new AsyncClientEntities(this, sdkConfiguration);
    }
     ...
     */
    public AsyncClientEntities async() {
        return asyncSDK;
    }
