...
public class AsyncPlatformSearch {
    private static final Headers _headers = Headers.EMPTY;
    private final SDKConfiguration sdkConfiguration;
    private final PlatformSearch syncSDK;

    AsyncPlatformSearch(PlatformSearch syncSDK, SDKConfiguration sdkConfiguration) {
    ...
    public CompletableFuture<PlatformSearchResponse> query(PlatformSearchRequest request) {
        AsyncRequestOperation<PlatformSearchRequest, PlatformSearchResponse> operation
              = new com.glean.api_client.glean_api_client.operations.PlatformSearch.Async(sdkConfiguration, _headers);
