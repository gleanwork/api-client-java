...
public class ClientSearch {
    ...
    private final AsyncClientSearch asyncSDK;

    ClientSearch(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.asyncSDK = new AsyncClientSearch(this, sdkConfiguration);
    }
     ...
     */
    public AsyncClientSearch async() {
        return asyncSDK;
    }
