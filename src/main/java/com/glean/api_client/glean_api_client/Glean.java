 ...
 * searching over applications that Glean does not currently support first class.
 * 
 * <p>In addition these APIs allow the customer to push organization data (people info, organization
 * structure etc) into Glean.
 * 
 * <p># Usage guidelines
