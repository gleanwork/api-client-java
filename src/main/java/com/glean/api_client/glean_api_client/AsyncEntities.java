...
public class AsyncEntities {
     ...
     */
    public CompletableFuture<GetPersonPhotoResponse> retrievePhoto(String personId) {
     ...
     * @return {@code CompletableFuture<GetPersonPhotoResponse>} - The async response
     */
    public CompletableFuture<GetPersonPhotoResponse> retrievePhoto(String personId, Optional<String> ds) {
