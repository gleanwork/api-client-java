...
public class AsyncClientEntities {
    private static final Headers _headers = Headers.EMPTY;
    private final SDKConfiguration sdkConfiguration;
    private final ClientEntities syncSDK;

    AsyncClientEntities(ClientEntities syncSDK, SDKConfiguration sdkConfiguration) {
