...
public class PreviewanswerRequest {
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public PreviewanswerRequest withXScioActas(String xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public PreviewanswerRequest withXScioActas(Optional<String> xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
        this.xScioActas = xScioActas;
        return this;
    }
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public PreviewanswerRequest withXGleanAuthType(String xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public PreviewanswerRequest withXGleanAuthType(Optional<String> xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
        this.xGleanAuthType = xGleanAuthType;
        return this;
    }
     ...
     * PreviewAnswer request
     */
    public PreviewanswerRequest withStructuredTextMutableProperties(StructuredTextMutableProperties structuredTextMutableProperties) {
        Utils.checkNotNull(structuredTextMutableProperties, "structuredTextMutableProperties");
        this.structuredTextMutableProperties = structuredTextMutableProperties;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PreviewanswerRequest other = (PreviewanswerRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PreviewanswerRequest.class,
    ...
    public final static class Builder {
        ...
        public PreviewanswerRequest build() {
            return new PreviewanswerRequest(
                xScioActas,
                xGleanAuthType,
                structuredTextMutableProperties);
        }
