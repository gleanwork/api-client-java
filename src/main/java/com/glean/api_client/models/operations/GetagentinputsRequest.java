...
public class GetagentinputsRequest {
    ...
    @JsonIgnore
    public GetAgentInputsRequest getAgentInputsRequest() {
        return getAgentInputsRequest;
    }
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public GetagentinputsRequest withXScioActas(String xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public GetagentinputsRequest withXScioActas(Optional<String> xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
        this.xScioActas = xScioActas;
        return this;
    }
     ...
     * The offset of the client's timezone in minutes from UTC. e.g. PDT is -420 because it's 7 hours behind UTC.
     */
    public GetagentinputsRequest withTimezoneOffset(long timezoneOffset) {
        Utils.checkNotNull(timezoneOffset, "timezoneOffset");
     ...
     * The offset of the client's timezone in minutes from UTC. e.g. PDT is -420 because it's 7 hours behind UTC.
     */
    public GetagentinputsRequest withTimezoneOffset(Optional<Long> timezoneOffset) {
        Utils.checkNotNull(timezoneOffset, "timezoneOffset");
        this.timezoneOffset = timezoneOffset;
        return this;
    }

    public GetagentinputsRequest withGetAgentInputsRequest(GetAgentInputsRequest getAgentInputsRequest) {
        Utils.checkNotNull(getAgentInputsRequest, "getAgentInputsRequest");
        this.getAgentInputsRequest = getAgentInputsRequest;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder getAgentInputsRequest(GetAgentInputsRequest getAgentInputsRequest) {
            Utils.checkNotNull(getAgentInputsRequest, "getAgentInputsRequest");
            this.getAgentInputsRequest = getAgentInputsRequest;
            return this;
        }
