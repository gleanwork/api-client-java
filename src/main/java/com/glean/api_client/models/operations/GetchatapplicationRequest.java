...
public class GetchatapplicationRequest {
    ...
    public GetchatapplicationRequest(
            GetChatApplicationRequest getChatApplicationRequest) {
        this(Optional.empty(), Optional.empty(), Optional.empty(), getChatApplicationRequest);
    }
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public GetchatapplicationRequest withXGleanActAs(String xGleanActAs) {
        Utils.checkNotNull(xGleanActAs, "xGleanActAs");
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public GetchatapplicationRequest withXGleanActAs(Optional<String> xGleanActAs) {
        Utils.checkNotNull(xGleanActAs, "xGleanActAs");
        this.xGleanActAs = xGleanActAs;
        return this;
    }
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public GetchatapplicationRequest withXGleanAuthType(String xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public GetchatapplicationRequest withXGleanAuthType(Optional<String> xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
        this.xGleanAuthType = xGleanAuthType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.getChatApplicationRequest, other.getChatApplicationRequest);
    }
