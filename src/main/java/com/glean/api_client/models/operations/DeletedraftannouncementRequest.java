...
public class DeletedraftannouncementRequest {
    ...
    @JsonCreator
    public DeletedraftannouncementRequest(
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public DeletedraftannouncementRequest withXScioActas(String xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public DeletedraftannouncementRequest withXScioActas(Optional<String> xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
        this.xScioActas = xScioActas;
        return this;
    }
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public DeletedraftannouncementRequest withXGleanAuthType(String xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public DeletedraftannouncementRequest withXGleanAuthType(Optional<String> xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
        this.xGleanAuthType = xGleanAuthType;
        return this;
    }
     ...
     * Delete draft announcement request
     */
    public DeletedraftannouncementRequest withDeleteAnnouncementRequest(DeleteAnnouncementRequest deleteAnnouncementRequest) {
        Utils.checkNotNull(deleteAnnouncementRequest, "deleteAnnouncementRequest");
        this.deleteAnnouncementRequest = deleteAnnouncementRequest;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeletedraftannouncementRequest other = (DeletedraftannouncementRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeletedraftannouncementRequest.class,
    ...
    public final static class Builder {
        ...
        public DeletedraftannouncementRequest build() {
            return new DeletedraftannouncementRequest(
                xScioActas,
                xGleanAuthType,
                deleteAnnouncementRequest);
        }
