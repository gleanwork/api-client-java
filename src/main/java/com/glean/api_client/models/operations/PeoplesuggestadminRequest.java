...
public class PeoplesuggestadminRequest {
    ...
    @JsonCreator
    public PeoplesuggestadminRequest(
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public PeoplesuggestadminRequest withXScioActas(String xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public PeoplesuggestadminRequest withXScioActas(Optional<String> xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
        this.xScioActas = xScioActas;
        return this;
    }
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public PeoplesuggestadminRequest withXGleanAuthType(String xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public PeoplesuggestadminRequest withXGleanAuthType(Optional<String> xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
        this.xGleanAuthType = xGleanAuthType;
        return this;
    }
     ...
     * Includes request params for type of suggestions.
     */
    public PeoplesuggestadminRequest withPeopleSuggestRequest(PeopleSuggestRequest peopleSuggestRequest) {
        Utils.checkNotNull(peopleSuggestRequest, "peopleSuggestRequest");
        this.peopleSuggestRequest = peopleSuggestRequest;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PeoplesuggestadminRequest other = (PeoplesuggestadminRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PeoplesuggestadminRequest.class,
    ...
    public final static class Builder {
        ...
        public PeoplesuggestadminRequest build() {
            return new PeoplesuggestadminRequest(
                xScioActas,
                xGleanAuthType,
                peopleSuggestRequest);
        }
