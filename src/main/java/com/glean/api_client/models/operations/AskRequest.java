...
public class AskRequest {
    ...
    private Optional<? extends com.glean.api_client.models.components.AskRequest> askRequest;

    @JsonCreator
    public AskRequest(
            Optional<String> xScioActas,
            Optional<String> xGleanAuthType,
            Optional<? extends com.glean.api_client.models.components.AskRequest> askRequest) {
    ...
    @JsonIgnore
    public Optional<com.glean.api_client.models.components.AskRequest> askRequest() {
        return (Optional<com.glean.api_client.models.components.AskRequest>) askRequest;
    }
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public AskRequest withXScioActas(String xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
     ...
     * Email address of a user on whose behalf the request is intended to be made (should be non-empty only for global tokens).
     */
    public AskRequest withXScioActas(Optional<String> xScioActas) {
        Utils.checkNotNull(xScioActas, "xScioActas");
        this.xScioActas = xScioActas;
        return this;
    }
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public AskRequest withXGleanAuthType(String xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
     ...
     * Auth type being used to access the endpoint (should be non-empty only for global tokens).
     */
    public AskRequest withXGleanAuthType(Optional<String> xGleanAuthType) {
        Utils.checkNotNull(xGleanAuthType, "xGleanAuthType");
        this.xGleanAuthType = xGleanAuthType;
        return this;
    }
     ...
     * Ask request
     */
    public AskRequest withAskRequest(com.glean.api_client.models.components.AskRequest askRequest) {
        Utils.checkNotNull(askRequest, "askRequest");
        this.askRequest = Optional.ofNullable(askRequest);
        return this;
    }
     ...
     * Ask request
     */
    public AskRequest withAskRequest(Optional<? extends com.glean.api_client.models.components.AskRequest> askRequest) {
        Utils.checkNotNull(askRequest, "askRequest");
        this.askRequest = askRequest;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.askRequest, other.askRequest);
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends com.glean.api_client.models.components.AskRequest> askRequest = Optional.empty();
         ...
         * Ask request
         */
        public Builder askRequest(com.glean.api_client.models.components.AskRequest askRequest) {
            Utils.checkNotNull(askRequest, "askRequest");
            this.askRequest = Optional.ofNullable(askRequest);
            return this;
        }
         ...
         * Ask request
         */
        public Builder askRequest(Optional<? extends com.glean.api_client.models.components.AskRequest> askRequest) {
            Utils.checkNotNull(askRequest, "askRequest");
            this.askRequest = askRequest;
            return this;
        }
