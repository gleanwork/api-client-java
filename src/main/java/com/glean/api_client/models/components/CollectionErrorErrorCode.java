...
public enum CollectionErrorErrorCode {
    ...
    public static Optional<CollectionErrorErrorCode> fromValue(String value) {
        for (CollectionErrorErrorCode o: CollectionErrorErrorCode.values()) {
