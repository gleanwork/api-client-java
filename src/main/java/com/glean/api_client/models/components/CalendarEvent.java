...
public class CalendarEvent {
    ...
    public CalendarEvent(
            String id,
            String url) {
        this(Optional.empty(), Optional.empty(), id, url, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
