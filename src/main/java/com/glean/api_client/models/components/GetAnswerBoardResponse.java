...
public class GetAnswerBoardResponse {
    ...
    public GetAnswerBoardResponse withBoardResult(AnswerBoardResult boardResult) {
        Utils.checkNotNull(boardResult, "boardResult");
        this.boardResult = Optional.ofNullable(boardResult);
        return this;
    }

    public GetAnswerBoardResponse withBoardResult(Optional<? extends AnswerBoardResult> boardResult) {
        Utils.checkNotNull(boardResult, "boardResult");
        this.boardResult = boardResult;
        return this;
    }

    public GetAnswerBoardResponse withError(AnswerBoardError error) {
        Utils.checkNotNull(error, "error");
        this.error = Optional.ofNullable(error);
        return this;
    }

    public GetAnswerBoardResponse withError(Optional<? extends AnswerBoardError> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
