...
public class CreateAnswerBoardResponse {
    ...
    public CreateAnswerBoardResponse withBoardResult(AnswerBoardResult boardResult) {
        Utils.checkNotNull(boardResult, "boardResult");
        this.boardResult = Optional.ofNullable(boardResult);
        return this;
    }

    public CreateAnswerBoardResponse withBoardResult(Optional<? extends AnswerBoardResult> boardResult) {
        Utils.checkNotNull(boardResult, "boardResult");
        this.boardResult = boardResult;
        return this;
    }

    public CreateAnswerBoardResponse withError(AnswerBoardError error) {
        Utils.checkNotNull(error, "error");
        this.error = Optional.ofNullable(error);
        return this;
    }

    public CreateAnswerBoardResponse withError(Optional<? extends AnswerBoardError> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
