...
import com.glean.api_client.models.components.ErrorMessage;
import com.glean.api_client.models.components.InvalidOperatorValueError;
...
public class ErrorInfo extends RuntimeException {
     ...
     * Indicates the gmail results could not be fetched due to bad token.
     */
    public ErrorInfo withBadGmailToken(boolean badGmailToken) {
        Utils.checkNotNull(badGmailToken, "badGmailToken");
     ...
     * Indicates the gmail results could not be fetched due to bad token.
     */
    public ErrorInfo withBadGmailToken(Optional<Boolean> badGmailToken) {
        Utils.checkNotNull(badGmailToken, "badGmailToken");
        this.badGmailToken = badGmailToken;
        return this;
    }
     ...
     * Indicates the outlook results could not be fetched due to bad token.
     */
    public ErrorInfo withBadOutlookToken(boolean badOutlookToken) {
        Utils.checkNotNull(badOutlookToken, "badOutlookToken");
     ...
     * Indicates the outlook results could not be fetched due to bad token.
     */
    public ErrorInfo withBadOutlookToken(Optional<Boolean> badOutlookToken) {
        Utils.checkNotNull(badOutlookToken, "badOutlookToken");
        this.badOutlookToken = badOutlookToken;
        return this;
    }
     ...
     * Indicates results could not be fetched due to invalid operators in the query.
     */
    public ErrorInfo withInvalidOperators(List<InvalidOperatorValueError> invalidOperators) {
        Utils.checkNotNull(invalidOperators, "invalidOperators");
     ...
     * Indicates results could not be fetched due to invalid operators in the query.
     */
    public ErrorInfo withInvalidOperators(Optional<? extends List<InvalidOperatorValueError>> invalidOperators) {
        Utils.checkNotNull(invalidOperators, "invalidOperators");
        this.invalidOperators = invalidOperators;
        return this;
    }

    public ErrorInfo withErrorMessages(List<ErrorMessage> errorMessages) {
        Utils.checkNotNull(errorMessages, "errorMessages");
        this.errorMessages = Optional.ofNullable(errorMessages);
        return this;
    }

    public ErrorInfo withErrorMessages(Optional<? extends List<ErrorMessage>> errorMessages) {
        Utils.checkNotNull(errorMessages, "errorMessages");
        this.errorMessages = errorMessages;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ErrorInfo.class,
