...
import com.glean.api_client.models.operations.MessagesRequestBuilder;
    ...
    public MessagesResponse retrieve(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.glean.api_client.models.components.MessagesResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.glean.api_client.models.components.MessagesResponse>() {});
