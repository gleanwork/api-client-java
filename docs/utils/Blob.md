...
The [`Blob`](../../src/main/java/com/glean/api_client/glean_api_client/utils/Blob.java) class provides factory methods for various input sources:
...
The [`Blob`](../../src/main/java/com/glean/api_client/glean_api_client/utils/Blob.java) class provides four methods for reading/consuming the data. All consumption methods use NIO and are safe to use in asynchronous contexts:
