# Client.Governance.Data.Findings.Exports
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreatefindingsexportResponse res = sdk.client().governance().data().findings().exports().create()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListfindingsexportsResponse res = sdk.client().governance().data().findings().exports().list()
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DownloadfindingsexportResponse res = sdk.client().governance().data().findings().exports().download()
                .id("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DeletefindingsexportResponse res = sdk.client().governance().data().findings().exports().delete()
                .id(741945L)
                .call();
