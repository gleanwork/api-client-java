...
public class Application {
    ...
    public static void main(String[] args) throws PlatformProblemDetailException, Exception {
        ...
        PlatformAgentsSearchResponse res = sdk.platform().agents().search()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws PlatformProblemDetailException, Exception {
        ...
        PlatformAgentsGetResponse res = sdk.platform().agents().get()
                .agentId("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws PlatformProblemDetailException, Exception {
        ...
        PlatformAgentsGetSchemasResponse res = sdk.platform().agents().getSchemas()
                .agentId("<id>")
                .includeTools(false)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws PlatformProblemDetailException, Exception {
        ...
        PlatformAgentsCreateRunResponse res = sdk.platform().agents().createRun()
                .agentId("<id>")
