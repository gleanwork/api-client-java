...
```java
import com.glean.api_client.glean_api_client.models.components.ActionAuthType;

ActionAuthType value = ActionAuthType.AUTH_USER_OAUTH;

// Open enum: use .of() to create instances from custom string values
ActionAuthType custom = ActionAuthType.of("custom_value");
```
